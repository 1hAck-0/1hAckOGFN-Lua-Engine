...
public:
	...
	unsigned char                                      UnknownData01[0x28];                                      // 0x0358(0x0028) UNKNOWN PROPERTY: SoftClassProperty Lobby.LobbyBeaconHost.LobbyStateClass
...
{
public:
	struct FText                                       DisplayName;                                              // 0x0330(0x0018) (Net)
