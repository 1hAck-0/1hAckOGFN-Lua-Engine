...
public:
	...
	unsigned char                                      UnknownData04[0x10];                                      // 0x048D(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty UMG.Slider.OnMouseCaptureBegin
	unsigned char                                      UnknownData05[0x10];                                      // 0x04A0(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty UMG.Slider.OnMouseCaptureEnd
	unsigned char                                      UnknownData06[0x10];                                      // 0x04B0(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty UMG.Slider.OnControllerCaptureBegin
	unsigned char                                      UnknownData07[0x10];                                      // 0x04C0(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty UMG.Slider.OnControllerCaptureEnd
	unsigned char                                      UnknownData08[0x10];                                      // 0x04D0(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty UMG.Slider.OnValueChanged
...
public:
	...
	unsigned char                                      UnknownData01[0x10];                                      // 0x03C4(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty UMG.Button.OnClicked
	unsigned char                                      UnknownData02[0x10];                                      // 0x03D8(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty UMG.Button.OnPressed
	unsigned char                                      UnknownData03[0x10];                                      // 0x03E8(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty UMG.Button.OnReleased
	unsigned char                                      UnknownData04[0x10];                                      // 0x03F8(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty UMG.Button.OnHovered
	unsigned char                                      UnknownData05[0x10];                                      // 0x0408(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty UMG.Button.OnUnhovered
...
public:
	...
	bool                                               AllowOverscroll;                                          // 0x0835(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	EDescendantScrollDestination                       NavigationDestination;                                    // 0x0836(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x1];                                       // 0x0837(0x0001) MISSED OFFSET
	...
	unsigned char                                      UnknownData03[0x10];                                      // 0x083D(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty UMG.ScrollBox.OnUserScrolled
...
public:
	...
	unsigned char                                      UnknownData00[0x10];                                      // 0x0110(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty UMG.ListViewBase.BP_OnEntryGenerated
	unsigned char                                      UnknownData01[0x10];                                      // 0x0120(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty UMG.ListViewBase.BP_OnEntryReleased
	unsigned char                                      UnknownData02[0xE0];                                      // 0x0130(0x00E0) MISSED OFFSET
...
public:
	...
	unsigned char                                      UnknownData03[0x10];                                      // 0x02D8(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty UMG.ListView.BP_OnItemClicked
	unsigned char                                      UnknownData04[0x10];                                      // 0x02F8(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty UMG.ListView.BP_OnItemDoubleClicked
	unsigned char                                      UnknownData05[0x10];                                      // 0x0308(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty UMG.ListView.BP_OnItemIsHoveredChanged
	unsigned char                                      UnknownData06[0x10];                                      // 0x0318(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty UMG.ListView.BP_OnItemSelectionChanged
	unsigned char                                      UnknownData07[0x10];                                      // 0x0328(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty UMG.ListView.BP_OnItemScrolledIntoView
...
public:
	...
	unsigned char                                      UnknownData01[0x10];                                      // 0x0338(0x0010) UNKNOWN PROPERTY: DelegateProperty UMG.TreeView.BP_OnGetItemChildren
	unsigned char                                      UnknownData02[0x10];                                      // 0x0358(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty UMG.TreeView.BP_OnItemExpansionChanged
...
{
public:
	unsigned char                                      UnknownData00[0x10];                                      // 0x0030(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty UMG.AsyncTaskDownloadImage.OnSuccess
	unsigned char                                      UnknownData01[0x10];                                      // 0x0040(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty UMG.AsyncTaskDownloadImage.OnFail
...
public:
	...
	unsigned char                                      UnknownData06[0x10];                                      // 0x0749(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty UMG.CheckBox.OnCheckStateChanged
...
public:
	...
	unsigned char                                      UnknownData04[0x10];                                      // 0x0C5C(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty UMG.ComboBoxString.OnSelectionChanged
	unsigned char                                      UnknownData05[0x10];                                      // 0x0C70(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty UMG.ComboBoxString.OnOpening
...
public:
	...
	unsigned char                                      UnknownData02[0x10];                                      // 0x0054(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty UMG.DragDropOperation.OnDrop
	unsigned char                                      UnknownData03[0x10];                                      // 0x0068(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty UMG.DragDropOperation.OnDragCancelled
	unsigned char                                      UnknownData04[0x10];                                      // 0x0078(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty UMG.DragDropOperation.OnDragged
...
public:
	...
	unsigned char                                      UnknownData04[0x10];                                      // 0x041D(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty UMG.EditableText.OnTextChanged
	unsigned char                                      UnknownData05[0x10];                                      // 0x0430(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty UMG.EditableText.OnTextCommitted
...
public:
	...
	unsigned char                                      UnknownData04[0x10];                                      // 0x09F5(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty UMG.EditableTextBox.OnTextChanged
	unsigned char                                      UnknownData05[0x10];                                      // 0x0A08(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty UMG.EditableTextBox.OnTextCommitted
...
public:
	...
	unsigned char                                      UnknownData02[0x10];                                      // 0x0308(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty UMG.ExpandableArea.OnExpansionChanged
...
public:
	...
	unsigned char                                      UnknownData01[0x10];                                      // 0x06C0(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty UMG.InputKeySelector.OnKeySelected
	unsigned char                                      UnknownData02[0x10];                                      // 0x06D0(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty UMG.InputKeySelector.OnIsSelectingKeyChanged
...
public:
	...
	unsigned char                                      UnknownData02[0x10];                                      // 0x013B(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty UMG.MenuAnchor.OnMenuOpenChanged
...
public:
	...
	unsigned char                                      UnknownData03[0x10];                                      // 0x042F(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty UMG.MultiLineEditableText.OnTextChanged
	unsigned char                                      UnknownData04[0x10];                                      // 0x0440(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty UMG.MultiLineEditableText.OnTextCommitted
...
public:
	...
	unsigned char                                      UnknownData02[0x10];                                      // 0x0C50(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty UMG.MultiLineEditableTextBox.OnTextChanged
	unsigned char                                      UnknownData03[0x10];                                      // 0x0C60(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty UMG.MultiLineEditableTextBox.OnTextCommitted
...
public:
	...
	TEnumAsByte<EOrientation>                          Orientation;                                              // 0x05E1(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
public:
	...
	unsigned char                                      UnknownData04[0x10];                                      // 0x04A0(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty UMG.SpinBox.OnValueChanged
	unsigned char                                      UnknownData05[0x10];                                      // 0x04B0(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty UMG.SpinBox.OnValueCommitted
	unsigned char                                      UnknownData06[0x10];                                      // 0x04C0(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty UMG.SpinBox.OnBeginSliderMovement
	unsigned char                                      UnknownData07[0x10];                                      // 0x04D0(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty UMG.SpinBox.OnEndSliderMovement
