...
{
	static auto fn = UObject::FindObject<UFunction>("Function Frontend_Research_Camera.Frontend_Research_Camera_C.UserConstructionScript");

	AFrontend_Research_Camera_C_UserConstructionScript_Params params;
