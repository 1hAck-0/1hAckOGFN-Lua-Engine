...
public:
	...
	struct FSoundAttenuationSettings                   AttenuationOverrides;                                     // 0x0258(0x02E8) (Edit, BlueprintVisible)
	class USoundConcurrency*                           ConcurrencySettings;                                      // 0x0540(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	TArray<struct FSoundSourceBusSendInfo>             PreEffectBusSends;                                        // 0x0580(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	unsigned char                                      bIsUISound : 1;                                           // 0x0590(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bIsPreviewSound : 1;                                      // 0x0590(0x0001)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0591(0x0003) MISSED OFFSET
	int                                                EnvelopeFollowerAttackTime;                               // 0x0594(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                EnvelopeFollowerReleaseTime;                              // 0x0598(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x059C(0x0004) MISSED OFFSET
	unsigned char                                      UnknownData02[0x10];                                      // 0x059C(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty AudioMixer.SynthComponent.OnAudioEnvelopeValue
	unsigned char                                      UnknownData03[0x20];                                      // 0x05B0(0x0020) MISSED OFFSET
	class USynthSound*                                 Synth;                                                    // 0x05D0(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	class UAudioComponent*                             AudioComponent;                                           // 0x05D8(0x0008) (ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData)
	unsigned char                                      UnknownData04[0x30];                                      // 0x05E0(0x0030) MISSED OFFSET
