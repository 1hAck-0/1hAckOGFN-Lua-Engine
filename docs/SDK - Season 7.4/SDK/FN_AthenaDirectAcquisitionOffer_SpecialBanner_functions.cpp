...
void UAthenaDirectAcquisitionOffer_SpecialBanner_C::SetupSpecialOfferBanner(bool bHasSale, struct FText SaleText, struct FString BannerOverrideTag, bool bHasBattlePassStars, int iNumOfBattlePassStars)
{
