...
{
public:
	struct FString                                     BeaconTypeName;                                           // 0x0330(0x0010) (ZeroConstructor, Transient)
...
{
public:
	unsigned char                                      UnknownData00[0x10];                                      // 0x0028(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty OnlineSubsystemUtils.AchievementQueryCallbackProxy.OnSuccess
	unsigned char                                      UnknownData01[0x10];                                      // 0x0038(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty OnlineSubsystemUtils.AchievementQueryCallbackProxy.OnFailure
...
{
public:
	unsigned char                                      UnknownData00[0x10];                                      // 0x0028(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty OnlineSubsystemUtils.AchievementWriteCallbackProxy.OnSuccess
	unsigned char                                      UnknownData01[0x10];                                      // 0x0038(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty OnlineSubsystemUtils.AchievementWriteCallbackProxy.OnFailure
...
{
public:
	unsigned char                                      UnknownData00[0x10];                                      // 0x0028(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty OnlineSubsystemUtils.ConnectionCallbackProxy.OnSuccess
	unsigned char                                      UnknownData01[0x10];                                      // 0x0038(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty OnlineSubsystemUtils.ConnectionCallbackProxy.OnFailure
...
{
public:
	unsigned char                                      UnknownData00[0x10];                                      // 0x0028(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty OnlineSubsystemUtils.CreateSessionCallbackProxy.OnSuccess
	unsigned char                                      UnknownData01[0x10];                                      // 0x0038(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty OnlineSubsystemUtils.CreateSessionCallbackProxy.OnFailure
...
{
public:
	unsigned char                                      UnknownData00[0x10];                                      // 0x0028(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty OnlineSubsystemUtils.DestroySessionCallbackProxy.OnSuccess
	unsigned char                                      UnknownData01[0x10];                                      // 0x0038(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty OnlineSubsystemUtils.DestroySessionCallbackProxy.OnFailure
	unsigned char                                      UnknownData02[0x28];                                      // 0x0048(0x0028) MISSED OFFSET
...
{
public:
	unsigned char                                      UnknownData00[0x10];                                      // 0x0028(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty OnlineSubsystemUtils.EndMatchCallbackProxy.OnSuccess
	unsigned char                                      UnknownData01[0x10];                                      // 0x0038(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty OnlineSubsystemUtils.EndMatchCallbackProxy.OnFailure
	unsigned char                                      UnknownData02[0x30];                                      // 0x0048(0x0030) MISSED OFFSET
...
{
public:
	unsigned char                                      UnknownData00[0x10];                                      // 0x0028(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty OnlineSubsystemUtils.EndTurnCallbackProxy.OnSuccess
	unsigned char                                      UnknownData01[0x10];                                      // 0x0038(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty OnlineSubsystemUtils.EndTurnCallbackProxy.OnFailure
	unsigned char                                      UnknownData02[0x28];                                      // 0x0048(0x0028) MISSED OFFSET
...
{
public:
	unsigned char                                      UnknownData00[0x10];                                      // 0x0028(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty OnlineSubsystemUtils.FindSessionsCallbackProxy.OnSuccess
	unsigned char                                      UnknownData01[0x10];                                      // 0x0038(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty OnlineSubsystemUtils.FindSessionsCallbackProxy.OnFailure
...
{
public:
	unsigned char                                      UnknownData00[0x10];                                      // 0x0028(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty OnlineSubsystemUtils.FindTurnBasedMatchCallbackProxy.OnSuccess
	unsigned char                                      UnknownData01[0x10];                                      // 0x0038(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty OnlineSubsystemUtils.FindTurnBasedMatchCallbackProxy.OnFailure
...
{
public:
	unsigned char                                      UnknownData00[0x10];                                      // 0x0028(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty OnlineSubsystemUtils.InAppPurchaseCallbackProxy.OnSuccess
	unsigned char                                      UnknownData01[0x10];                                      // 0x0038(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty OnlineSubsystemUtils.InAppPurchaseCallbackProxy.OnFailure
	unsigned char                                      UnknownData02[0x38];                                      // 0x0048(0x0038) MISSED OFFSET
...
{
public:
	unsigned char                                      UnknownData00[0x10];                                      // 0x0028(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty OnlineSubsystemUtils.InAppPurchaseQueryCallbackProxy.OnSuccess
	unsigned char                                      UnknownData01[0x10];                                      // 0x0038(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty OnlineSubsystemUtils.InAppPurchaseQueryCallbackProxy.OnFailure
	unsigned char                                      UnknownData02[0x48];                                      // 0x0048(0x0048) MISSED OFFSET
...
{
public:
	unsigned char                                      UnknownData00[0x10];                                      // 0x0028(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty OnlineSubsystemUtils.InAppPurchaseRestoreCallbackProxy.OnSuccess
	unsigned char                                      UnknownData01[0x10];                                      // 0x0038(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty OnlineSubsystemUtils.InAppPurchaseRestoreCallbackProxy.OnFailure
	unsigned char                                      UnknownData02[0x48];                                      // 0x0048(0x0048) MISSED OFFSET
...
{
public:
	unsigned char                                      UnknownData00[0x10];                                      // 0x0028(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty OnlineSubsystemUtils.JoinSessionCallbackProxy.OnSuccess
	unsigned char                                      UnknownData01[0x10];                                      // 0x0038(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty OnlineSubsystemUtils.JoinSessionCallbackProxy.OnFailure
...
{
public:
	unsigned char                                      UnknownData00[0x10];                                      // 0x0028(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty OnlineSubsystemUtils.LeaderboardFlushCallbackProxy.OnSuccess
	unsigned char                                      UnknownData01[0x10];                                      // 0x0038(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty OnlineSubsystemUtils.LeaderboardFlushCallbackProxy.OnFailure
...
{
public:
	unsigned char                                      UnknownData00[0x10];                                      // 0x0028(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty OnlineSubsystemUtils.LeaderboardQueryCallbackProxy.OnSuccess
	unsigned char                                      UnknownData01[0x10];                                      // 0x0038(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty OnlineSubsystemUtils.LeaderboardQueryCallbackProxy.OnFailure
...
{
public:
	unsigned char                                      UnknownData00[0x10];                                      // 0x0030(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty OnlineSubsystemUtils.LogoutCallbackProxy.OnSuccess
	unsigned char                                      UnknownData01[0x10];                                      // 0x0040(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty OnlineSubsystemUtils.LogoutCallbackProxy.OnFailure
...
{
public:
	unsigned char                                      UnknownData00[0x10];                                      // 0x0028(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty OnlineSubsystemUtils.QuitMatchCallbackProxy.OnSuccess
	unsigned char                                      UnknownData01[0x10];                                      // 0x0038(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty OnlineSubsystemUtils.QuitMatchCallbackProxy.OnFailure
	unsigned char                                      UnknownData02[0x28];                                      // 0x0048(0x0028) MISSED OFFSET
...
{
public:
	unsigned char                                      UnknownData00[0x10];                                      // 0x0030(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty OnlineSubsystemUtils.ShowLoginUICallbackProxy.OnSuccess
	unsigned char                                      UnknownData01[0x10];                                      // 0x0040(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty OnlineSubsystemUtils.ShowLoginUICallbackProxy.OnFailure
