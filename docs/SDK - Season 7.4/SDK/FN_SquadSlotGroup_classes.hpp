...
public:
	...
	struct FMargin                                     SquadSlotPadding;                                         // 0x0280(0x0010) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	struct FSlateBrush                                 HeaderImageBrush;                                         // 0x02D0(0x0088) (Edit, BlueprintVisible)
	unsigned char                                      UnknownData02[0x10];                                      // 0x0358(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty SquadSlotGroup.SquadSlotGroup_C.HandleMouseEnter
	unsigned char                                      UnknownData03[0x10];                                      // 0x0368(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty SquadSlotGroup.SquadSlotGroup_C.HandleMouseLeave
