...
void UPlayerBanner_C::SetBannerIconAndColor(struct FName IconId, struct FName ColorId)
{
...
void UPlayerBanner_C::SetBannerOwner(struct FUniqueNetIdRepl OwnerId)
{
...
void UPlayerBanner_C::SetBannerColorId(struct FName InBannerColorId)
{
...
void UPlayerBanner_C::SetBannerIconId(struct FName InBannerIconId)
{
...
void UPlayerBanner_C::SetBannerImage(struct FFortHomeBaseInfo Image_info, bool* Success)
{
...
void UPlayerBanner_C::OnTeamMemberStateChanged(struct FFortTeamMemberInfo TeamMemberInfo)
{
...
void UPlayerBanner_C::Account_Info_Changed(struct FFortPublicAccountInfo NewInfo)
{
