...
{
	static auto fn = UObject::FindObject<UFunction>("Function B_CameraLens_Blinkstrike.B_CameraLens_Blinkstrike_C.UserConstructionScript");

	AB_CameraLens_Blinkstrike_C_UserConstructionScript_Params params;
