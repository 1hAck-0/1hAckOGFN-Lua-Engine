...
bool UAssetRegistryHelpers::STATIC_GetTagValue(struct FAssetData InAssetData, struct FName InTagName, struct FString* OutTagValue)
{
...
struct FString UAssetRegistryHelpers::STATIC_GetFullName(struct FAssetData InAssetData)
{
...
struct FString UAssetRegistryHelpers::STATIC_GetExportTextName(struct FAssetData InAssetData)
{
...
void UAssetRegistry::GetSubPaths(struct FString InBasePath, bool bInRecurse, TArray<struct FString>* OutPathList)
{
