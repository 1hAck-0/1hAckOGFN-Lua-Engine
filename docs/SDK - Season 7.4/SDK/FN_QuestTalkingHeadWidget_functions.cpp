...
void UQuestTalkingHeadWidget_C::HandleTalkingHeadBegin(class UTexture2D* Image, struct FText Title, struct FText Subtitle, EFortAnnouncementDisplayPreference DisplayPreference)
{
...
void UQuestTalkingHeadWidget_C::SetTalkingHeadSubtitle(struct FText Subtitle)
{
...
void UQuestTalkingHeadWidget_C::SetTalkingHeadName(struct FText Title)
{
