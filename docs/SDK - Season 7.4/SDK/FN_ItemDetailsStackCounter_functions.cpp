...
{
	static auto fn = UObject::FindObject<UFunction>("Function ItemDetailsStackCounter.ItemDetailsStackCounter_C.HandleQuantityOverrideChanged");

	UItemDetailsStackCounter_C_HandleQuantityOverrideChanged_Params params;
