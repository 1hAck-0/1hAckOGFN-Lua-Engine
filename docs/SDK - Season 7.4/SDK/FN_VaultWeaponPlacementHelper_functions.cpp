...
void AVaultWeaponPlacementHelper_C::OnTeamMemberStateChanged(struct FFortTeamMemberInfo TeamMemberInfo)
{
...
void AVaultWeaponPlacementHelper_C::OnTeamMemberAdded(struct FFortTeamMemberInfo TeamMemberInfo)
{
