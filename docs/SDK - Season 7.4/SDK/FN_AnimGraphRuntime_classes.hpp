...
{
public:
	unsigned char                                      UnknownData00[0x10];                                      // 0x0028(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty AnimGraphRuntime.PlayMontageCallbackProxy.OnCompleted
	unsigned char                                      UnknownData01[0x10];                                      // 0x0038(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty AnimGraphRuntime.PlayMontageCallbackProxy.OnBlendOut
	unsigned char                                      UnknownData02[0x10];                                      // 0x0048(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty AnimGraphRuntime.PlayMontageCallbackProxy.OnInterrupted
	unsigned char                                      UnknownData03[0x10];                                      // 0x0058(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty AnimGraphRuntime.PlayMontageCallbackProxy.OnNotifyBegin
	unsigned char                                      UnknownData04[0x10];                                      // 0x0068(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty AnimGraphRuntime.PlayMontageCallbackProxy.OnNotifyEnd
