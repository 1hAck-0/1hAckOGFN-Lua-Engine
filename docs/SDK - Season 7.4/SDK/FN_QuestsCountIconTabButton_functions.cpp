...
void UQuestsCountIconTabButton_C::SetTutorialNameID(struct FName InTutorialBangID)
{
...
void UQuestsCountIconTabButton_C::Set_Icon(struct FSlateBrush IconBrush)
{
...
void UQuestsCountIconTabButton_C::Set_Text(struct FText ButtonText)
{
