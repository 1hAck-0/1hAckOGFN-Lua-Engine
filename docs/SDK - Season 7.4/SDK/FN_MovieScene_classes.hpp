...
public:
	...
	unsigned char                                      UnknownData01[0x10];                                      // 0x0028(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty MovieScene.MovieSceneSequencePlayer.OnPlay
	unsigned char                                      UnknownData02[0x10];                                      // 0x0380(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty MovieScene.MovieSceneSequencePlayer.OnPlayReverse
	unsigned char                                      UnknownData03[0x10];                                      // 0x0390(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty MovieScene.MovieSceneSequencePlayer.OnStop
	unsigned char                                      UnknownData04[0x10];                                      // 0x03A0(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty MovieScene.MovieSceneSequencePlayer.OnPause
	unsigned char                                      UnknownData05[0x10];                                      // 0x03B0(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty MovieScene.MovieSceneSequencePlayer.OnFinished
	...
	struct FMovieSceneSequencePlaybackSettings         PlaybackSettings;                                         // 0x03F0(0x0010) (Net)
	struct FMovieSceneRootEvaluationTemplateInstance   RootTemplateInstance;                                     // 0x0400(0x0300) (Transient)
	unsigned char                                      UnknownData09[0x68];                                      // 0x0700(0x0068) MISSED OFFSET
	struct FMovieSceneSequenceReplProperties           NetSyncProps;                                             // 0x0768(0x0010) (Net)
	TScriptInterface<class UMovieScenePlaybackClient>  PlaybackClient;                                           // 0x0778(0x0010) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData10[0x38];                                      // 0x0788(0x0038) MISSED OFFSET
