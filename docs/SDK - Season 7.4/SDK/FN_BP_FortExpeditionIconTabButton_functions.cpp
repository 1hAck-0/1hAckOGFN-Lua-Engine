...
void UBP_FortExpeditionIconTabButton_C::Set_Tab_Id(struct FName TabId)
{
...
void UBP_FortExpeditionIconTabButton_C::Set_Icon(struct FSlateBrush IconBrush)
{
...
void UBP_FortExpeditionIconTabButton_C::Set_Text(struct FText ButtonText)
{
