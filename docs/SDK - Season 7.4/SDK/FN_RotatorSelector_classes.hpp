...
public:
	...
	class USpacer*                                     Spacer_1;                                                 // 0x0260(0x0008) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, RepNotify, Interp, NonTransactional, EditorOnly, NoDestructor, AutoWeak, ContainsInstancedReference, AssetRegistrySearchable, SimpleDisplay, AdvancedDisplay, Protected, BlueprintCallable, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)
	...
	struct FText                                       HoverText;                                                // 0x0278(0x0018) (Edit, BlueprintVisible, DisableEditOnInstance)
	unsigned char                                      UnknownData01[0x10];                                      // 0x0290(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty RotatorSelector.RotatorSelector_C.Selection Changed
	...
	float                                              Spacer_Width;                                             // 0x02A8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	void Initialize(struct FText Display_Text, struct FText Hover_Text, class UCommonTextBlock* Tab_Tooltip, TArray<struct FText>* Options);
