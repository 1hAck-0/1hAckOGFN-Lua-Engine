...
class UGCN_S8_Destruction_C : public UFortGameplayCueNotify_Burst
{
public:

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass GCN_S8_Destruction.GCN_S8_Destruction_C");
		return ptr;
	}
