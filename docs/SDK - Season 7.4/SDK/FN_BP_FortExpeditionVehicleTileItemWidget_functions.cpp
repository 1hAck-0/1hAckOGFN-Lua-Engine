...
void UBP_FortExpeditionVehicleTileItemWidget_C::Set_Name(struct FName SquadId)
{
...
void UBP_FortExpeditionVehicleTileItemWidget_C::OnVehicleSelected__DelegateSignature(struct FName SquadId)
{
