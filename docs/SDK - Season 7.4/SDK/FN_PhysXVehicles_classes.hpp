...
{
public:
	class USkeletalMeshComponent*                      Mesh;                                                     // 0x0390(0x0008) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, EditConst, InstancedReference, IsPlainOldData)
	class UWheeledVehicleMovementComponent*            VehicleMovement;                                          // 0x0398(0x0008) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, EditConst, InstancedReference, IsPlainOldData)
...
{
public:
	struct FVehicleEngineData                          EngineSetup;                                              // 0x02D8(0x00A0) (Edit)
	struct FVehicleDifferential4WData                  DifferentialSetup;                                        // 0x0378(0x001C) (Edit)
	float                                              AckermannAccuracy;                                        // 0x0394(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	struct FVehicleTransmissionData                    TransmissionSetup;                                        // 0x0398(0x0030) (Edit)
