...
{
	static auto fn = UObject::FindObject<UFunction>("Function GC_Abilities_Activation_Ninja_ShadowStance.GC_Abilities_Activation_Ninja_ShadowStance_C.Restore Material on Weapon Mesh");

	AGC_Abilities_Activation_Ninja_ShadowStance_C_Restore_Material_on_Weapon_Mesh_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function GC_Abilities_Activation_Ninja_ShadowStance.GC_Abilities_Activation_Ninja_ShadowStance_C.Override Material and Copy Parameters on Weapon Mesh");

	AGC_Abilities_Activation_Ninja_ShadowStance_C_Override_Material_and_Copy_Parameters_on_Weapon_Mesh_Params params;
	params.Player_Pawn = Player_Pawn;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function GC_Abilities_Activation_Ninja_ShadowStance.GC_Abilities_Activation_Ninja_ShadowStance_C.Restore OG Materials");

	AGC_Abilities_Activation_Ninja_ShadowStance_C_Restore_OG_Materials_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function GC_Abilities_Activation_Ninja_ShadowStance.GC_Abilities_Activation_Ninja_ShadowStance_C.Destroy Duplicate Mesh");

	AGC_Abilities_Activation_Ninja_ShadowStance_C_Destroy_Duplicate_Mesh_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function GC_Abilities_Activation_Ninja_ShadowStance.GC_Abilities_Activation_Ninja_ShadowStance_C.Create Duplicate Mesh");

	AGC_Abilities_Activation_Ninja_ShadowStance_C_Create_Duplicate_Mesh_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function GC_Abilities_Activation_Ninja_ShadowStance.GC_Abilities_Activation_Ninja_ShadowStance_C.Override Material to Dissolve Material");

	AGC_Abilities_Activation_Ninja_ShadowStance_C_Override_Material_to_Dissolve_Material_Params params;
	params.NInja_Pawn = NInja_Pawn;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function GC_Abilities_Activation_Ninja_ShadowStance.GC_Abilities_Activation_Ninja_ShadowStance_C.Save Material");

	AGC_Abilities_Activation_Ninja_ShadowStance_C_Save_Material_Params params;
	params.NInja_Pawn = NInja_Pawn;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function GC_Abilities_Activation_Ninja_ShadowStance.GC_Abilities_Activation_Ninja_ShadowStance_C.OnWeaponEquipped");

	AGC_Abilities_Activation_Ninja_ShadowStance_C_OnWeaponEquipped_Params params;
