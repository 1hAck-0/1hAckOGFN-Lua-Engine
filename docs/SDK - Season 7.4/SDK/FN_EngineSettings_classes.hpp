...
public:
	...
	TArray<struct FSubLevelStrippingInfo>              SubLevelClassesToStrip;                                   // 0x0088(0x0010) (Edit, ZeroConstructor, Config)
	struct FSoftObjectPath                             GameDefaultMap;                                           // 0x0098(0x0018) (Edit, ZeroConstructor, Config)
	struct FSoftObjectPath                             ServerDefaultMap;                                         // 0x00B0(0x0018) (Edit, ZeroConstructor, Config)
	struct FSoftClassPath                              GlobalDefaultGameMode;                                    // 0x00C8(0x0018) (Edit, ZeroConstructor, Config, NoClear)
	struct FSoftClassPath                              GlobalDefaultServerGameMode;                              // 0x00E0(0x0018) (Edit, ZeroConstructor, Config)
	TArray<struct FGameModeName>                       GameModeMapPrefixes;                                      // 0x00F8(0x0010) (Edit, ZeroConstructor, Config)
	TArray<struct FGameModeName>                       GameModeClassAliases;                                     // 0x0108(0x0010) (Edit, ZeroConstructor, Config)
