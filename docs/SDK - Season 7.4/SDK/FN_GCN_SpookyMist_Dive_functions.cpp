...
void UGCN_SpookyMist_Dive_C::OnStartParticleSystemSpawned(class UParticleSystemComponent* SpawnedParticleSysComponent, struct FGameplayCueParameters Parameters)
{
	static auto fn = UObject::FindObject<UFunction>("Function GCN_SpookyMist_Dive.GCN_SpookyMist_Dive_C.OnStartParticleSystemSpawned");

	UGCN_SpookyMist_Dive_C_OnStartParticleSystemSpawned_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function GCN_SpookyMist_Dive.GCN_SpookyMist_Dive_C.OnActive");

	UGCN_SpookyMist_Dive_C_OnActive_Params params;
