...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass GA_GM_OnDmgDealtBase.GA_GM_OnDmgDealtBase_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_GA_GM_OnDmgDealtBase(int EntryPoint);
};
