...
void UGAB_GenericDeath_C::GetRandomSectionName(int MaxNumberOfSections, struct FName OriginalSectionName, struct FName* SectionName)
{
...
void UGAB_GenericDeath_C::InitializeDeathHitDirection(struct FGameplayEventData EventHitData)
{
