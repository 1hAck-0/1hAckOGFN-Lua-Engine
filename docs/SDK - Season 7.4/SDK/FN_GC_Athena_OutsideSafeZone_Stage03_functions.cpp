...
void AGC_Athena_OutsideSafeZone_Stage03_C::Timeline()
{
	static auto fn = UObject::FindObject<UFunction>("Function GC_Athena_OutsideSafeZone_Stage03.GC_Athena_OutsideSafeZone_Stage03_C.Timeline");

	AGC_Athena_OutsideSafeZone_Stage03_C_Timeline_Params params;
...
void AGC_Athena_OutsideSafeZone_Stage03_C::On_Distant_Lightning_Spawn(struct FName EventName, float EmitterTime, struct FVector Location, struct FVector Velocity)
{
