...
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_BattlePassUnlockAnim.BP_BattlePassUnlockAnim_C.GetWidgetForFramingViewedItem");

	UBP_BattlePassUnlockAnim_C_GetWidgetForFramingViewedItem_Params params;
