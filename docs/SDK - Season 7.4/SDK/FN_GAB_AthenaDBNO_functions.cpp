...
void UGAB_AthenaDBNO_C::InitializeDeathHitDirection(struct FGameplayEventData EventHitData)
{
...
// Function GAB_AthenaDBNO.GAB_AthenaDBNO_C.OnFinish
// (BlueprintCallable, BlueprintEvent)

void UGAB_AthenaDBNO_C::OnFinish()
{
	static auto fn = UObject::FindObject<UFunction>("Function GAB_AthenaDBNO.GAB_AthenaDBNO_C.OnFinish");

	UGAB_AthenaDBNO_C_OnFinish_Params params;
