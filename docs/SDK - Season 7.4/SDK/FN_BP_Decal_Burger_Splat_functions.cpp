...
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_Decal_Burger_Splat.BP_Decal_Burger_Splat_C.UserConstructionScript");

	ABP_Decal_Burger_Splat_C_UserConstructionScript_Params params;
