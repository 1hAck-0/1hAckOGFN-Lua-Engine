...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_Fortnite_CommanderLights.BP_Fortnite_CommanderLights_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_Fortnite_CommanderLights(int EntryPoint);
};
