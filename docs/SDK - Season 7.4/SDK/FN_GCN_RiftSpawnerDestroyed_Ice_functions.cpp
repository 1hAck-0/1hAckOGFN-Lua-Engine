...
{
	static auto fn = UObject::FindObject<UFunction>("Function GCN_RiftSpawnerDestroyed_Ice.GCN_RiftSpawnerDestroyed_Ice_C.OnBurst");

	UGCN_RiftSpawnerDestroyed_Ice_C_OnBurst_Params params;
