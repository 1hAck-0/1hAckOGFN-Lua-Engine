...
// Parameters:
// bool                           Large                          (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)

void UStoreMain_MTXOffer_C::SetTileSize(bool Large)
{
	static auto fn = UObject::FindObject<UFunction>("Function StoreMain_MTXOffer.StoreMain_MTXOffer_C.SetTileSize");
