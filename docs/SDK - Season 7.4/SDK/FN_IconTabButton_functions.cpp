...
{
	static auto fn = UObject::FindObject<UFunction>("Function IconTabButton.IconTabButton_C.Play Hover Sound");
...
void UIconTabButton_C::SetChangeIconColorWhenSelected(bool ChangeColorWhenSelected, struct FSlateColor SelectedColor, struct FSlateColor UnselectedColor)
{
...
void UIconTabButton_C::Set_Icon(struct FSlateBrush IconBrush)
{
...
void UIconTabButton_C::Set_Text(struct FText ButtonText)
{
