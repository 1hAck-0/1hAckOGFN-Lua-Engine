...
{
	struct FMovieSceneSequenceLoopCount                LoopCount;                                                // 0x0000(0x0004) (Edit, BlueprintVisible)
	...
	unsigned char                                      bRandomStartTime : 1;                                     // 0x000C(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bRestoreState : 1;                                        // 0x000C(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bDisableMovementInput : 1;                                // 0x000C(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bDisableLookAtInput : 1;                                  // 0x000C(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bHidePlayer : 1;                                          // 0x000C(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bHideHud : 1;                                             // 0x000C(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bDisableCameraCuts : 1;                                   // 0x000C(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bPauseAtEnd : 1;                                          // 0x000C(0x0001) (Edit, BlueprintVisible)
