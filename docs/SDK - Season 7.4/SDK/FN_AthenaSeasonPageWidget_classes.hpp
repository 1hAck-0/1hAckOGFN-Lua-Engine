...
public:
	...
	unsigned char                                      UnknownData00[0x10];                                      // 0x0298(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty AthenaSeasonPageWidget.AthenaSeasonPageWidget_C.PageLeft
	unsigned char                                      UnknownData01[0x10];                                      // 0x02A8(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty AthenaSeasonPageWidget.AthenaSeasonPageWidget_C.PageRight
