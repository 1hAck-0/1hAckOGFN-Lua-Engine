...
{
	static auto fn = UObject::FindObject<UFunction>("Function GC_Ninja_Assassination_ActiveFX.GC_Ninja_Assassination_ActiveFX_C.ReceiveBeginPlay");

	AGC_Ninja_Assassination_ActiveFX_C_ReceiveBeginPlay_Params params;
