...
public:
	...
	unsigned char                                      bStopAILogicOnUnposses : 1;                               // 0x03E8(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bLOSflag : 1;                                             // 0x03E8(0x0001)
	unsigned char                                      bSkipExtraLOSChecks : 1;                                  // 0x03E8(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bAllowStrafe : 1;                                         // 0x03E8(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bWantsPlayerState : 1;                                    // 0x03E8(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bSetControlRotationFromPawnOrientation : 1;               // 0x03E8(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      UnknownData01[0x7];                                       // 0x03E9(0x0007) MISSED OFFSET
	class UPathFollowingComponent*                     PathFollowingComponent;                                   // 0x03F0(0x0008) (Edit, ExportObject, ZeroConstructor, DisableEditOnInstance, EditConst, InstancedReference, IsPlainOldData)
	class UBrainComponent*                             BrainComponent;                                           // 0x03F8(0x0008) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UAIPerceptionComponent*                      PerceptionComponent;                                      // 0x0400(0x0008) (Edit, ExportObject, ZeroConstructor, DisableEditOnInstance, EditConst, InstancedReference, IsPlainOldData)
	class UPawnActionsComponent*                       ActionsComp;                                              // 0x0408(0x0008) (BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UBlackboardComponent*                        Blackboard;                                               // 0x0410(0x0008) (BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UGameplayTasksComponent*                     CachedGameplayTasksComponent;                             // 0x0418(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UClass*                                      DefaultNavigationFilterClass;                             // 0x0420(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x10];                                      // 0x0428(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty AIModule.AIController.ReceiveMoveCompleted
...
public:
	...
	unsigned char                                      UnknownData02[0x10];                                      // 0x0128(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty AIModule.AIPerceptionComponent.OnPerceptionUpdated
	unsigned char                                      UnknownData03[0x10];                                      // 0x01B8(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty AIModule.AIPerceptionComponent.OnTargetPerceptionUpdated
...
public:
	...
	class UNavMovementComponent*                       MovementComp;                                             // 0x0130(0x0008) (ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData)
	unsigned char                                      UnknownData01[0x8];                                       // 0x0138(0x0008) MISSED OFFSET
	class ANavigationData*                             MyNavData;                                                // 0x0140(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
...
public:
	...
	struct FVector                                     CrowdAgentMoveDirection;                                  // 0x02B0(0x000C) (ZeroConstructor, IsPlainOldData)
...
public:
	...
	TArray<struct FNavigationLink>                     PointLinks;                                               // 0x0340(0x0010) (Edit, ZeroConstructor)
	TArray<struct FNavigationSegmentLink>              SegmentLinks;                                             // 0x0350(0x0010) (ZeroConstructor)
	class UNavLinkCustomComponent*                     SmartLinkComp;                                            // 0x0360(0x0008) (Edit, ExportObject, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
	bool                                               bSmartLinkIsRelevant;                                     // 0x0368(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x7];                                       // 0x0369(0x0007) MISSED OFFSET
	unsigned char                                      UnknownData02[0x10];                                      // 0x0369(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty AIModule.NavLinkProxy.OnSmartLinkReached
...
{
public:
	unsigned char                                      UnknownData00[0x10];                                      // 0x0070(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty AIModule.AITask_MoveTo.OnRequestFailed
	unsigned char                                      UnknownData01[0x10];                                      // 0x0080(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty AIModule.AITask_MoveTo.OnMoveFinished
...
{
public:
	unsigned char                                      UnknownData00[0x10];                                      // 0x0028(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty AIModule.AIAsyncTaskBlueprintProxy.OnSuccess
	unsigned char                                      UnknownData01[0x10];                                      // 0x0038(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty AIModule.AIAsyncTaskBlueprintProxy.OnFail
...
public:
	...
	unsigned char                                      UnknownData03[0x10];                                      // 0x0064(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty AIModule.EnvQueryInstanceBlueprintWrapper.OnQueryFinishedEvent
...
{
public:
	class UNavLocalGridManager*                        GridManager;                                              // 0x02A0(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
...
public:
	...
	unsigned char                                      UnknownData01[0x10];                                      // 0x010D(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty AIModule.PawnSensingComponent.OnSeePawn
	unsigned char                                      UnknownData02[0x10];                                      // 0x0128(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty AIModule.PawnSensingComponent.OnHearNoise
