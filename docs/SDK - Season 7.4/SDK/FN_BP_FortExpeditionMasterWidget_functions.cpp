...
void UBP_FortExpeditionMasterWidget_C::Disable_Input_Action(struct FDataTableRowHandle InputActionRow)
{
...
void UBP_FortExpeditionMasterWidget_C::Show_Input_Action(struct FDataTableRowHandle InputActionRow)
{
...
void UBP_FortExpeditionMasterWidget_C::Hide_Input_Action(struct FDataTableRowHandle InputActionRow)
{
...
// Function BP_FortExpeditionMasterWidget.BP_FortExpeditionMasterWidget_C.DialogResult
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// EFortDialogResult              Result                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
// struct FName                   ResultName                     (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)

void UBP_FortExpeditionMasterWidget_C::DialogResult(EFortDialogResult Result, struct FName ResultName)
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_FortExpeditionMasterWidget.BP_FortExpeditionMasterWidget_C.DialogResult");

	UBP_FortExpeditionMasterWidget_C_DialogResult_Params params;
