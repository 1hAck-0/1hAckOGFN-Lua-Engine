...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Frontend_Research_Camera.Frontend_Research_Camera_C");
		return ptr;
	}
	...
	void OnActivated();
	void OnDeactivated();
	void ExecuteUbergraph_Frontend_Research_Camera(int EntryPoint);
};
