...
{
	static auto fn = UObject::FindObject<UFunction>("Function GCN_Hoverboard_Running.GCN_Hoverboard_Running_C.WhileActive");

	AGCN_Hoverboard_Running_C_WhileActive_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function GCN_Hoverboard_Running.GCN_Hoverboard_Running_C.OnExecute");

	AGCN_Hoverboard_Running_C_OnExecute_Params params;
	params.MyTarget = MyTarget;
	params.Parameters = Parameters;
...
bool AGCN_Hoverboard_Running_C::IsPlayerJumping(struct FVector InVec)
{
