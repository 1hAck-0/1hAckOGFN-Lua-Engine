...
void APlayerPawn_Constructor_C::GameplayCue_Damage(TEnumAsByte<EGameplayCueEvent> EventType, struct FGameplayCueParameters Parameters)
{
...
void APlayerPawn_Constructor_C::GameplayCue_Constructor_PlasmaPulse_IFFCoding(TEnumAsByte<EGameplayCueEvent> EventType, struct FGameplayCueParameters Parameters)
{
...
void APlayerPawn_Constructor_C::GameplayCue_Constructor_ToInfinityAndBeyond_ActiveFX(TEnumAsByte<EGameplayCueEvent> EventType, struct FGameplayCueParameters Parameters)
{
...
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// class AB_Perk_C_Constructor_BASE_C* SavedBASE2                     (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)

void APlayerPawn_Constructor_C::SetBase2(class AB_Perk_C_Constructor_BASE_C* SavedBASE2)
{
	static auto fn = UObject::FindObject<UFunction>("Function PlayerPawn_Constructor.PlayerPawn_Constructor_C.SetBase2");

	APlayerPawn_Constructor_C_SetBase2_Params params;
	params.SavedBASE2 = SavedBASE2;
...
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// struct FVector                 Plasma_Pulse_Location          (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)

void APlayerPawn_Constructor_C::SetPlasmaPulseLocation(struct FVector Plasma_Pulse_Location)
{
	static auto fn = UObject::FindObject<UFunction>("Function PlayerPawn_Constructor.PlayerPawn_Constructor_C.SetPlasmaPulseLocation");

	APlayerPawn_Constructor_C_SetPlasmaPulseLocation_Params params;
	params.Plasma_Pulse_Location = Plasma_Pulse_Location;
