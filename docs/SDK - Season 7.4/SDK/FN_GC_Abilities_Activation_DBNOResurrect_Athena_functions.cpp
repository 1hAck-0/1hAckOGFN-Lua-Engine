...
{
	static auto fn = UObject::FindObject<UFunction>("Function GC_Abilities_Activation_DBNOResurrect_Athena.GC_Abilities_Activation_DBNOResurrect_Athena_C.OnBurst");

	UGC_Abilities_Activation_DBNOResurrect_Athena_C_OnBurst_Params params;
