...
{
	static auto fn = UObject::FindObject<UFunction>("Function NormalBangWrapper.NormalBangWrapper_C.SetShouldSuppressBang");
...
void UNormalBangWrapper_C::Adjust_Bang_Image_Translation(struct FVector2D Translation)
{
...
void UNormalBangWrapper_C::OnStartCallout(struct FName TutorialObjectiveName, ETutorialType TutorialType)
{
