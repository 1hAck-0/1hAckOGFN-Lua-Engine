...
{
	static auto fn = UObject::FindObject<UFunction>("Function GC_Abilities_Death_FadeCapsule_StW.GC_Abilities_Death_FadeCapsule_StW_C.UserConstructionScript");

	AGC_Abilities_Death_FadeCapsule_StW_C_UserConstructionScript_Params params;
