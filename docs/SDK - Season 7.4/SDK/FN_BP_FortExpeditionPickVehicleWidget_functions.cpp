...
// Function BP_FortExpeditionPickVehicleWidget.BP_FortExpeditionPickVehicleWidget_C.BndEvt__CommonTileView
// (BlueprintEvent)
// Parameters:
// class UUserWidget*             Widget                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData)

void UBP_FortExpeditionPickVehicleWidget_C::BndEvt__CommonTileView(class UUserWidget* Widget)
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_FortExpeditionPickVehicleWidget.BP_FortExpeditionPickVehicleWidget_C.BndEvt__CommonTileView");

	UBP_FortExpeditionPickVehicleWidget_C_BndEvt__CommonTileView_Params params;
...
void UBP_FortExpeditionPickVehicleWidget_C::HandleVehicleSelected(struct FName SquadId)
{
...
void UBP_FortExpeditionPickVehicleWidget_C::OnVehicleSelected__DelegateSignature(struct FName SquadId)
{
