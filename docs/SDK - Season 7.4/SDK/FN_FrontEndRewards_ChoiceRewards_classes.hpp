...
public:
	...
	class UWidgetAnimation*                            AnimFadeOut;                                              // 0x0268(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, RepSkip, RepNotify, Interp, NonTransactional, EditorOnly, NoDestructor, AutoWeak, ContainsInstancedReference, AssetRegistrySearchable, SimpleDisplay, AdvancedDisplay, Protected, BlueprintCallable, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)
	...
	unsigned char                                      UnknownData01[0x10];                                      // 0x02F0(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty FrontEndRewards_ChoiceRewards.FrontEndRewards_ChoiceRewards_C.OnRewardSelected
	...
	class USoundBase*                                  ChooseRewardSound;                                        // 0x0338(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class USoundBase*                                  ChooseRewardGivenSound;                                   // 0x0340(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	...
	void BndEvt__ButtonSure_K2Node_ComponentBoundEvent(class UCommonButton* Button);
	void BndEvt__ButtonNope_K2Node_ComponentBoundEvent(class UCommonButton* Button);
