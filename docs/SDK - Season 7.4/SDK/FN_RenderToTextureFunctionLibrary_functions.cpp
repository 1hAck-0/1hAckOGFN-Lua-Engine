...
void URenderToTextureFunctionLibrary_C::STATIC_Set_Canvas_Material_Scale_and_Position(struct FVector2D Size, struct FVector2D Position, float Scale, class UObject* __WorldContext, struct FVector2D* Screen_Position, struct FVector2D* Screen_Size)
{
