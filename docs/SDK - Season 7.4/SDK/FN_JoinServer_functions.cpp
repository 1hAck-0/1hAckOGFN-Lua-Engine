...
void UJoinServer_C::ShowRetryRejoinWindow(struct FText Failure, bool AllowRetry)
{
...
{
	static auto fn = UObject::FindObject<UFunction>("Function JoinServer.JoinServer_C.RemoveRejoinWindowDuringRejoin");

	UJoinServer_C_RemoveRejoinWindowDuringRejoin_Params params;
...
void UJoinServer_C::DialogResult_B65B7C6342A70AAA7E4C689EE8A624BF(EFortDialogResult Result, struct FName ResultName)
{
