...
{
	static auto fn = UObject::FindObject<UFunction>("Function UIManager.UIManager_C.HasActiveModalWidget");

	UUIManager_C_HasActiveModalWidget_Params params;
...
void UUIManager_C::DisplayWebPurchase(class UWidget* WebWidget, struct FString OfferId)
{
...
void UUIManager_C::ShowErrorInErrorWindow(struct FFortErrorInfo ErrorInfo)
{
...
void UUIManager_C::QueueConfirmation(struct FFortDialogDescription_NUI ConfirmationDescription)
{
...
// Function UIManager.UIManager_C.DialogResult
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// EFortDialogResult              Result                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
// struct FName                   ResultName                     (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)

void UUIManager_C::DialogResult(EFortDialogResult Result, struct FName ResultName)
{
	static auto fn = UObject::FindObject<UFunction>("Function UIManager.UIManager_C.DialogResult");

	UUIManager_C_DialogResult_Params params;
