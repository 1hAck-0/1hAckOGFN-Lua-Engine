...
void UQuestMiniTile2_C::BndEvt__QuestButton_K2Node_ComponentBoundEvent(class UCommonButton* Button, bool Selected)
{
	static auto fn = UObject::FindObject<UFunction>("Function QuestMiniTile2.QuestMiniTile2_C.BndEvt__QuestButton_K2Node_ComponentBoundEvent");

	UQuestMiniTile2_C_BndEvt__QuestButton_K2Node_ComponentBoundEvent_Params params;
