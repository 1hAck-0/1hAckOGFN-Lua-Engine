...
{
	static auto fn = UObject::FindObject<UFunction>("Function GCNL_Athena_SnowSurface.GCNL_Athena_SnowSurface_C.UserConstructionScript");

	AGCNL_Athena_SnowSurface_C_UserConstructionScript_Params params;
