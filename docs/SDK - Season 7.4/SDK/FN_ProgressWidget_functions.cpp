...
void UProgressWidget_C::SetIcon(struct FSlateBrush IconBrush)
{
...
void UProgressWidget_C::SetDescription(struct FText Description)
{
...
void UProgressWidget_C::SetTitle(struct FText Title)
{
