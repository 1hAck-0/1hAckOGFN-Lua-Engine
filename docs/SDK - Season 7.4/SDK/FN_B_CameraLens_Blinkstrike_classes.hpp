...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass B_CameraLens_Blinkstrike.B_CameraLens_Blinkstrike_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_B_CameraLens_Blinkstrike(int EntryPoint);
};
