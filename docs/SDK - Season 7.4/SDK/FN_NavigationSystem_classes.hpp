...
public:
	...
	unsigned char                                      UnknownData06[0x10];                                      // 0x0088(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty NavigationSystem.NavigationSystemV1.OnNavDataRegisteredEvent
	unsigned char                                      UnknownData07[0x10];                                      // 0x00F8(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty NavigationSystem.NavigationSystemV1.OnNavigationGenerationFinishedDelegate
	unsigned char                                      UnknownData08[0xCC];                                      // 0x0108(0x00CC) MISSED OFFSET
	EFNavigationSystemRunMode                          OperationMode;                                            // 0x01D4(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData09[0x23B];                                     // 0x01D5(0x023B) MISSED OFFSET
...
{
public:
	unsigned char                                      UnknownData00[0x10];                                      // 0x0028(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty NavigationSystem.NavigationPath.PathUpdatedNotifier
...
public:
	...
	TArray<struct FNavigationLink>                     Links;                                                    // 0x0578(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
