...
void UToastWidget_MinorError_C::ShowText(struct FText Text, class UCommonTextBlock* TextBlock)
{
...
// Function ToastWidget_MinorError.ToastWidget_MinorError_C.BndEvt__OpenButton_K2Node_ComponentBoundEvent
// (BlueprintEvent)
// Parameters:
// class UCommonButton*           Button                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData)

void UToastWidget_MinorError_C::BndEvt__OpenButton_K2Node_ComponentBoundEvent(class UCommonButton* Button)
{
	static auto fn = UObject::FindObject<UFunction>("Function ToastWidget_MinorError.ToastWidget_MinorError_C.BndEvt__OpenButton_K2Node_ComponentBoundEvent");

	UToastWidget_MinorError_C_BndEvt__OpenButton_K2Node_ComponentBoundEvent_Params params;
