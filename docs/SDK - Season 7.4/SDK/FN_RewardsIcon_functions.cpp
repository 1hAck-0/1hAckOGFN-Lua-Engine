...
struct FEventReply URewardsIcon_C::OnMouseButtonDown(struct FGeometry MyGeometry, struct FPointerEvent MouseEvent)
{
	static auto fn = UObject::FindObject<UFunction>("Function RewardsIcon.RewardsIcon_C.OnMouseButtonDown");

	URewardsIcon_C_OnMouseButtonDown_Params params;
