...
struct FEventReply UAthenaMatchmakingOptionsDisplay_v2_C::Touch_To_Close(struct FGeometry MyGeometry, struct FPointerEvent MouseEvent)
{
...
void UAthenaMatchmakingOptionsDisplay_v2_C::SetSquadFillText(ESquadFillSetting InSquadFillSetting)
{
	...
	params.InSquadFillSetting = InSquadFillSetting;
...
void UAthenaMatchmakingOptionsDisplay_v2_C::BndEvt__AcceptButton_K2Node_ComponentBoundEvent(class UCommonButton* Button)
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaMatchmakingOptionsDisplay_v2.AthenaMatchmakingOptionsDisplay_v2_C.BndEvt__AcceptButton_K2Node_ComponentBoundEvent");

	UAthenaMatchmakingOptionsDisplay_v2_C_BndEvt__AcceptButton_K2Node_ComponentBoundEvent_Params params;
...
void UAthenaMatchmakingOptionsDisplay_v2_C::BndEvt__CancelButton_K2Node_ComponentBoundEvent(class UCommonButton* Button)
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaMatchmakingOptionsDisplay_v2.AthenaMatchmakingOptionsDisplay_v2_C.BndEvt__CancelButton_K2Node_ComponentBoundEvent");

	UAthenaMatchmakingOptionsDisplay_v2_C_BndEvt__CancelButton_K2Node_ComponentBoundEvent_Params params;
	params.Button = Button;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaMatchmakingOptionsDisplay_v2.AthenaMatchmakingOptionsDisplay_v2_C.ApplyCMSOverrides");

	UAthenaMatchmakingOptionsDisplay_v2_C_ApplyCMSOverrides_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaMatchmakingOptionsDisplay_v2.AthenaMatchmakingOptionsDisplay_v2_C.OnDeactivated");

	UAthenaMatchmakingOptionsDisplay_v2_C_OnDeactivated_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaMatchmakingOptionsDisplay_v2.AthenaMatchmakingOptionsDisplay_v2_C.UpdateMMButtonStatusBP");

	UAthenaMatchmakingOptionsDisplay_v2_C_UpdateMMButtonStatusBP_Params params;
	params.bPlaylistIsEnabled = bPlaylistIsEnabled;
	params.FillDisableReason = FillDisableReason;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaMatchmakingOptionsDisplay_v2.AthenaMatchmakingOptionsDisplay_v2_C.SetServerAccessText");

	UAthenaMatchmakingOptionsDisplay_v2_C_SetServerAccessText_Params params;
	params.InServerAccessSetting = InServerAccessSetting;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaMatchmakingOptionsDisplay_v2.AthenaMatchmakingOptionsDisplay_v2_C.SetSpectatorButtonText");

	UAthenaMatchmakingOptionsDisplay_v2_C_SetSpectatorButtonText_Params params;
	params.InSpectatorQueueType = InSpectatorQueueType;
