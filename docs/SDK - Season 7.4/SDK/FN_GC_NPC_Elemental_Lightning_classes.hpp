...
public:
	...
	class UParticleSystemComponent*                    P_Husk_Elemental_Electric_AuxObjs;                        // 0x03A8(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UParticleSystemComponent*                    Lightning_Elemental_FX;                                   // 0x03B0(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData)
	...
	void Rerun();
	void ExecuteUbergraph_GC_NPC_Elemental_Lightning(int EntryPoint);
};
