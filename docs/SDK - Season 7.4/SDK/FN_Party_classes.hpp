...
public:
	...
	TMap<struct FString, class USocialChatRoom*>       ChatRoomsById;                                            // 0x00C8(0x0050) (ZeroConstructor)
	TMap<struct FString, class USocialReadOnlyChatChannel*> ReadOnlyChannelsByDisplayName;                            // 0x0118(0x0050) (ZeroConstructor)
