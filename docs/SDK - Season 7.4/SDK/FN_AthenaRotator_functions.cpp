...
void UAthenaRotator_C::BndEvt__ButtonLeft_K2Node_ComponentBoundEvent(class UCommonButton* Button)
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaRotator.AthenaRotator_C.BndEvt__ButtonLeft_K2Node_ComponentBoundEvent");

	UAthenaRotator_C_BndEvt__ButtonLeft_K2Node_ComponentBoundEvent_Params params;
...
void UAthenaRotator_C::BndEvt__ButtonRight_K2Node_ComponentBoundEvent(class UCommonButton* Button)
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaRotator.AthenaRotator_C.BndEvt__ButtonRight_K2Node_ComponentBoundEvent");

	UAthenaRotator_C_BndEvt__ButtonRight_K2Node_ComponentBoundEvent_Params params;
	params.Button = Button;
