...
public:
	...
	unsigned char                                      UnknownData04[0x10];                                      // 0x0158(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty GameplayTasks.GameplayTasksComponent.OnClaimedResourcesChange
...
{
public:
	unsigned char                                      UnknownData00[0x10];                                      // 0x0068(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty GameplayTasks.GameplayTask_SpawnActor.Success
	unsigned char                                      UnknownData01[0x10];                                      // 0x0078(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty GameplayTasks.GameplayTask_SpawnActor.DidNotSpawn
...
{
public:
	unsigned char                                      UnknownData00[0x10];                                      // 0x0068(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty GameplayTasks.GameplayTask_TimeLimitedExecution.OnFinished
	unsigned char                                      UnknownData01[0x10];                                      // 0x0078(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty GameplayTasks.GameplayTask_TimeLimitedExecution.OnTimeExpired
...
{
public:
	unsigned char                                      UnknownData00[0x10];                                      // 0x0068(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty GameplayTasks.GameplayTask_WaitDelay.OnFinish
