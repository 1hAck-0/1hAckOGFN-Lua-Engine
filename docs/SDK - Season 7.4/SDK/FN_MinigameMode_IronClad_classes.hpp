...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass MinigameMode_IronClad.MinigameMode_IronClad_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_MinigameMode_IronClad(int EntryPoint);
};
