...
struct FMovieSceneAudioSectionTemplateData
{
	...
	unsigned char                                      UnknownData03[0x10];                                      // 0x0178(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty MovieSceneTracks.MovieSceneAudioSectionTemplateData.OnAudioFinished
	unsigned char                                      UnknownData04[0x10];                                      // 0x0188(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty MovieSceneTracks.MovieSceneAudioSectionTemplateData.OnAudioPlaybackPercent
};
