...
public:
	...
	unsigned char                                      UnknownData01[0x10];                                      // 0x027C(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty BP_FortExpeditionReturnsWidget.BP_FortExpeditionReturnsWidget_C.OnExpeditionCompleted
