...
void AGCNL_GM_Fury_C::OnEnemyDeath(class AActor* DeadActor, float Damage, class AFortPawn* InstigatedBy, struct FVector HitLocation, class AActor* DamageCauser)
{
