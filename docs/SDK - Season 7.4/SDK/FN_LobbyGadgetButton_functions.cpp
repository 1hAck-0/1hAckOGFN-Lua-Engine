...
void ULobbyGadgetButton_C::BndEvt__Button_K2Node_ComponentBoundEvent(class UCommonButton* Button)
{
	static auto fn = UObject::FindObject<UFunction>("Function LobbyGadgetButton.LobbyGadgetButton_C.BndEvt__Button_K2Node_ComponentBoundEvent");

	ULobbyGadgetButton_C_BndEvt__Button_K2Node_ComponentBoundEvent_Params params;
