...
// Parameters:
// struct FVector                 Wind_location                  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
...
void AWindManager_C::Find_Matching_Wind_Mesh_Index_And_Write_Bool(struct FVector Wind_location, bool* Storm_Cyl_Mesh_Match, int* Wind_Cyl_Mesh_Array_Match_Index)
{
...
// struct FVector                 AnimatedCylinderCenter         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
...
// struct FVector                 CylinderCenter                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
// bool                           Set_WindVector                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
// struct FVector                 WindVector                     (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
// bool                           Set_WindCrossVector            (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
// struct FVector                 WindCrossVector                (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
...
void AWindManager_C::UpdateStormWindCylinder(struct FFortWindImpulseCylinder Wind_Impulse, struct FFortWindImpulseCylinderDelta Wind_Delta)
{
...
void AWindManager_C::Play_Water_Splash_Particle_System_At_Location(struct FTransform Particle_Transform)
{
