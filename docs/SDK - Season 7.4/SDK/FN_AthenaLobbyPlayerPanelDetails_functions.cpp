...
void UAthenaLobbyPlayerPanelDetails_C::OnTeamMemberStateChanged(struct FFortTeamMemberInfo ChangedTeamMemberInfo)
{
...
void UAthenaLobbyPlayerPanelDetails_C::SetTeamMemberInfo(struct FFortTeamMemberInfo TeamMemberInfo)
{
