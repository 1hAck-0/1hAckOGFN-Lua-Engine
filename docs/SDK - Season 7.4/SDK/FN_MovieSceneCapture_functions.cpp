...
void UUserDefinedCaptureProtocol::StartCapturingFinalPixels(struct FName StreamName)
{
...
void UUserDefinedCaptureProtocol::ResolveBuffer(class UTexture* Buffer, struct FName BufferName)
{
...
void UUserDefinedCaptureProtocol::PushBufferToStream(class UTexture* Buffer, struct FName StreamName)
{
...
void UUserDefinedCaptureProtocol::BindToStream(struct FName StreamName)
{
...
void UUserDefinedImageCaptureProtocol::WriteImageToDisk(struct FCapturedPixels PixelData, struct FName StreamName, struct FFrameMetrics FrameMetrics, bool bCopyImageData)
{
...
struct FString UUserDefinedImageCaptureProtocol::GenerateFilenameForBuffer(class UTexture* Buffer, struct FName StreamName)
{
