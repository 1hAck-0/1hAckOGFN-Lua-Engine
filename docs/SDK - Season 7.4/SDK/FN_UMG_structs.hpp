...
struct FAnimationEventBinding
{
	...
	unsigned char                                      UnknownData00[0x10];                                      // 0x0008(0x0010) UNKNOWN PROPERTY: DelegateProperty UMG.AnimationEventBinding.Delegate
...
struct FWidgetNavigationData
{
	...
	unsigned char                                      UnknownData01[0x10];                                      // 0x0014(0x0010) UNKNOWN PROPERTY: DelegateProperty UMG.WidgetNavigationData.CustomDelegate
};
