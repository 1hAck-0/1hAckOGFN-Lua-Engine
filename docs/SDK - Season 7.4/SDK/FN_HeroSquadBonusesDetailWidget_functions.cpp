...
{
	static auto fn = UObject::FindObject<UFunction>("Function HeroSquadBonusesDetailWidget.HeroSquadBonusesDetailWidget_C.UpdateRootVisibility");

	UHeroSquadBonusesDetailWidget_C_UpdateRootVisibility_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function HeroSquadBonusesDetailWidget.HeroSquadBonusesDetailWidget_C.Construct");

	UHeroSquadBonusesDetailWidget_C_Construct_Params params;
