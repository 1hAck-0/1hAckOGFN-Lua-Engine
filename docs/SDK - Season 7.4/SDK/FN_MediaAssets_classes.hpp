...
{
public:
	unsigned char                                      UnknownData00[0x10];                                      // 0x0028(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty MediaAssets.MediaPlayer.OnEndReached
	unsigned char                                      UnknownData01[0x10];                                      // 0x0038(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty MediaAssets.MediaPlayer.OnMediaClosed
	unsigned char                                      UnknownData02[0x10];                                      // 0x0048(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty MediaAssets.MediaPlayer.OnMediaOpened
	unsigned char                                      UnknownData03[0x10];                                      // 0x0058(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty MediaAssets.MediaPlayer.OnMediaOpenFailed
	unsigned char                                      UnknownData04[0x10];                                      // 0x0068(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty MediaAssets.MediaPlayer.OnPlaybackResumed
	unsigned char                                      UnknownData05[0x10];                                      // 0x0078(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty MediaAssets.MediaPlayer.OnPlaybackSuspended
	unsigned char                                      UnknownData06[0x10];                                      // 0x0088(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty MediaAssets.MediaPlayer.OnSeekCompleted
	unsigned char                                      UnknownData07[0x10];                                      // 0x0098(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty MediaAssets.MediaPlayer.OnTracksChanged
...
{
public:
	EMediaSoundChannels                                Channels;                                                 // 0x0610(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0610(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	bool                                               DynamicRateAdjustment;                                    // 0x0614(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0615(0x0003) MISSED OFFSET
	float                                              RateAdjustmentFactor;                                     // 0x0618(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	struct FFloatRange                                 RateAdjustmentRange;                                      // 0x061C(0x0010) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x4];                                       // 0x062C(0x0004) MISSED OFFSET
	class UMediaPlayer*                                MediaPlayer;                                              // 0x0630(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x1E8];                                     // 0x0638(0x01E8) MISSED OFFSET
