...
struct FGameplayAbilityRepAnimMontage
{
	...
	unsigned char                                      bSkipPlayRate : 1;                                        // 0x0015(0x0001)
...
struct FGameplayEffectExecutionScopedModifierInfo
{
	...
	struct FGameplayEffectModifierMagnitude            ModifierMagnitude;                                        // 0x0030(0x0190) (Edit, DisableEditOnInstance)
	struct FGameplayModEvaluationChannelSettings       EvaluationChannelSettings;                                // 0x01C0(0x0001) (Edit, DisableEditOnInstance)
	unsigned char                                      UnknownData01[0x7];                                       // 0x01C1(0x0007) MISSED OFFSET
	struct FGameplayTagRequirements                    SourceTags;                                               // 0x01C8(0x0040) (Edit, DisableEditOnInstance)
	struct FGameplayTagRequirements                    TargetTags;                                               // 0x0208(0x0040) (Edit, DisableEditOnInstance)
};
