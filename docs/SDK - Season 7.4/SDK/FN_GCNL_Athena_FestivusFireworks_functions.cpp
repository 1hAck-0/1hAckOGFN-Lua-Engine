...
{
	static auto fn = UObject::FindObject<UFunction>("Function GCNL_Athena_FestivusFireworks.GCNL_Athena_FestivusFireworks_C.UserConstructionScript");

	AGCNL_Athena_FestivusFireworks_C_UserConstructionScript_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function GCNL_Athena_FestivusFireworks.GCNL_Athena_FestivusFireworks_C.OnLoopingStart");

	AGCNL_Athena_FestivusFireworks_C_OnLoopingStart_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function GCNL_Athena_FestivusFireworks.GCNL_Athena_FestivusFireworks_C.OnRemoval");

	AGCNL_Athena_FestivusFireworks_C_OnRemoval_Params params;
	params.MyTarget = MyTarget;
	params.Parameters = Parameters;
	params.ParticleComponents = ParticleComponents;
	params.AudioComponents = AudioComponents;
...
void AGCNL_Athena_FestivusFireworks_C::ExecuteUbergraph_GCNL_Athena_FestivusFireworks(int EntryPoint)
{
	static auto fn = UObject::FindObject<UFunction>("Function GCNL_Athena_FestivusFireworks.GCNL_Athena_FestivusFireworks_C.ExecuteUbergraph_GCNL_Athena_FestivusFireworks");

	AGCNL_Athena_FestivusFireworks_C_ExecuteUbergraph_GCNL_Athena_FestivusFireworks_Params params;
