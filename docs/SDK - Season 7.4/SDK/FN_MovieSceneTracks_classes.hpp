...
public:
	...
	unsigned char                                      UnknownData01[0x10];                                      // 0x0248(0x0010) UNKNOWN PROPERTY: DelegateProperty MovieSceneTracks.MovieSceneAudioSection.OnQueueSubtitles
	unsigned char                                      UnknownData02[0x10];                                      // 0x0258(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty MovieSceneTracks.MovieSceneAudioSection.OnAudioFinished
	unsigned char                                      UnknownData03[0x10];                                      // 0x0268(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty MovieSceneTracks.MovieSceneAudioSection.OnAudioPlaybackPercent
...
{
public:
	class UClass*                                      PropertyClass;                                            // 0x0080(0x0008) (ZeroConstructor, IsPlainOldData)
