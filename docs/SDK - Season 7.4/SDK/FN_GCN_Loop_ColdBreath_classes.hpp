...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass GCN_Loop_ColdBreath.GCN_Loop_ColdBreath_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_GCN_Loop_ColdBreath(int EntryPoint);
};
