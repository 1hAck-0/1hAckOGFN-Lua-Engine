...
void UFullPartyMemberConnected_C::UpdateDimensions(struct FVector2D NewDimensions)
{
...
void UFullPartyMemberConnected_C::UpdateMemberInfo(struct FFortTeamMemberInfo NewMemberInfo)
{
