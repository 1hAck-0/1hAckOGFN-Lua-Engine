...
{
	static auto fn = UObject::FindObject<UFunction>("Function PurchaseHistoryEntry.PurchaseHistoryEntry_C.UpdateItemList");

	UPurchaseHistoryEntry_C_UpdateItemList_Params params;
	params.ItemCards = ItemCards;
