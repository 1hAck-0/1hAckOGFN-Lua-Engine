...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_FortniteResearchLights.BP_FortniteResearchLights_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_FortniteResearchLights(int EntryPoint);
};
