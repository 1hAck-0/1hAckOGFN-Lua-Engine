...
struct AGC_Melee_Piercing_Spear_Joust_Loop_C_UserConstructionScript_Params
{
};

// Function GC_Melee_Piercing_Spear_Joust_Loop.GC_Melee_Piercing_Spear_Joust_Loop_C.OnLoopingStart
struct AGC_Melee_Piercing_Spear_Joust_Loop_C_OnLoopingStart_Params
{
...
struct AGC_Melee_Piercing_Spear_Joust_Loop_C_OnRemoval_Params
{
	class AActor*                                      MyTarget;                                                 // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
	struct FGameplayCueParameters                      Parameters;                                               // (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
	TArray<class UParticleSystemComponent*>            ParticleComponents;                                       // (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, ReferenceParm)
...
struct AGC_Melee_Piercing_Spear_Joust_Loop_C_ExecuteUbergraph_GC_Melee_Piercing_Spear_Joust_Loop_Params
{
