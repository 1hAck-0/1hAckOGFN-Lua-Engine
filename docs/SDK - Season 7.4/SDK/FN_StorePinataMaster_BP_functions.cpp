...
void AStorePinataMaster_BP_C::InpActEvt_LeftMouseButton_K2Node_InputKeyEvent_4(struct FKey Key)
{
...
void AStorePinataMaster_BP_C::InpActEvt_LeftMouseButton_K2Node_InputKeyEvent_3(struct FKey Key)
{
...
void AStorePinataMaster_BP_C::InpActEvt_Gamepad_RightTrigger_K2Node_InputKeyEvent_2(struct FKey Key)
{
...
void AStorePinataMaster_BP_C::InpActEvt_Gamepad_RightTrigger_K2Node_InputKeyEvent_1(struct FKey Key)
{
...
void AStorePinataMaster_BP_C::InpTchEvt_Released(TEnumAsByte<ETouchIndex> FingerIndex, struct FVector Location)
{
...
void AStorePinataMaster_BP_C::InpTchEvt_Pressed(TEnumAsByte<ETouchIndex> FingerIndex, struct FVector Location)
{
...
// Function StorePinataMaster_BP.StorePinataMaster_BP_C.OnLoaded
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// class UClass*                  Loaded                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)

void AStorePinataMaster_BP_C::OnLoaded(class UClass* Loaded)
{
	static auto fn = UObject::FindObject<UFunction>("Function StorePinataMaster_BP.StorePinataMaster_BP_C.OnLoaded");

	AStorePinataMaster_BP_C_OnLoaded_Params params;
