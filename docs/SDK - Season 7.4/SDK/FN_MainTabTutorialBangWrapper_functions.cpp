...
void UMainTabTutorialBangWrapper_C::SetShouldSuppressBang(bool ShouldSuppressBang)
{
	static auto fn = UObject::FindObject<UFunction>("Function MainTabTutorialBangWrapper.MainTabTutorialBangWrapper_C.SetShouldSuppressBang");

	UMainTabTutorialBangWrapper_C_SetShouldSuppressBang_Params params;
...
void UMainTabTutorialBangWrapper_C::SetUIFeatureRevealData(EFortUIFeature UIFeature, struct FText RevealText)
{
...
void UMainTabTutorialBangWrapper_C::Adjust_Bang_Image_Translation(struct FVector2D Translation)
{
...
void UMainTabTutorialBangWrapper_C::OnStartCallout(struct FName TutorialObjectiveName, ETutorialType TutorialType)
{
