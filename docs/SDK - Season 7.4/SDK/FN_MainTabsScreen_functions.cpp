...
void UMainTabsScreen_C::CheckDisplayCriteria(TEnumAsByte<EStoreOfferCosts> InCustomStoreOfferCost, struct FCardPackOffer InCardPackOffer, bool* bPassedDisplayCriteria)
{
...
void UMainTabsScreen_C::GetCustomStoreOfferCost(struct FCardPackOffer InCardPackOffer, TEnumAsByte<EStoreOfferCosts>* OutCustomStoreOfferCost)
{
...
void UMainTabsScreen_C::HandleCardPackStore(struct FName TabId)
{
...
void UMainTabsScreen_C::HandleMtxStore(struct FName Tab_Id)
{
...
void UMainTabsScreen_C::Update_Store_Tab_Button_Bang(struct FName Tab)
{
...
void UMainTabsScreen_C::Update_Quest_Tab_Button_Bang(struct FName Tab)
{
...
void UMainTabsScreen_C::Update_Tab_Button_Bangs(struct FName InTab)
{
...
void UMainTabsScreen_C::Update_Hero_Tab_Button_Bang(struct FName Tab)
{
...
void UMainTabsScreen_C::Update_Squad_Tab_Button_Bang(struct FName Tab)
{
...
void UMainTabsScreen_C::HandleTabSelected(struct FName TabName)
{
...
void UMainTabsScreen_C::HandleTabCreated(struct FName TabId, class UCommonButton* TabButton)
{
...
void UMainTabsScreen_C::CustomEvent(struct FName TabId, class UCommonButton* TabButton)
{
...
void UMainTabsScreen_C::Tick(struct FGeometry MyGeometry, float InDeltaTime)
{
	static auto fn = UObject::FindObject<UFunction>("Function MainTabsScreen.MainTabsScreen_C.Tick");

	UMainTabsScreen_C_Tick_Params params;
