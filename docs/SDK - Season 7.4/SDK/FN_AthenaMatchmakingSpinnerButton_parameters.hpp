...
struct UAthenaMatchmakingSpinnerButton_C_BP_OnDoubleClicked_Params
{
};

// Function AthenaMatchmakingSpinnerButton.AthenaMatchmakingSpinnerButton_C.BP_OnClicked
struct UAthenaMatchmakingSpinnerButton_C_BP_OnClicked_Params
{
};

// Function AthenaMatchmakingSpinnerButton.AthenaMatchmakingSpinnerButton_C.Construct
struct UAthenaMatchmakingSpinnerButton_C_Construct_Params
{
};
...
struct UAthenaMatchmakingSpinnerButton_C_BndEvt__SimpleCommonButton_Params
{
...
struct UAthenaMatchmakingSpinnerButton_C_BndEvt__SimpleCommonButton_K2Node_ComponentBoundEvent_Params
{
	class UCommonButton*                               Button;                                                   // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData)
};
