...
{
	static auto fn = UObject::FindObject<UFunction>("Function GC_HuskDeath.GC_HuskDeath_C.OnBurst");

	AGC_HuskDeath_C_OnBurst_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function GC_HuskDeath.GC_HuskDeath_C.UserConstructionScript");

	AGC_HuskDeath_C_UserConstructionScript_Params params;
