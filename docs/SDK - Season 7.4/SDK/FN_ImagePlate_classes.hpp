...
{
public:
	class UImagePlateComponent*                        ImagePlate;                                               // 0x0330(0x0008) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
...
{
public:
	struct FImagePlateParameters                       Plate;                                                    // 0x0570(0x0038) (Edit)
	unsigned char                                      UnknownData00[0x98];                                      // 0x05A8(0x0098) MISSED OFFSET
