...
void UAthenaLobbyPlayerPanel_C::OnTeamMemberStateChanged(struct FFortTeamMemberInfo TeamMemberInfo)
{
...
void UAthenaLobbyPlayerPanel_C::SetTeamMemberInfo(struct FFortTeamMemberInfo TeamMemberInfo)
{
