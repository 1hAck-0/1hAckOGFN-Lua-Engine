...
void UFullPartyMember_C::HandleLocalPlayerActionsResult(EFortDialogResult Result, struct FName ResultName)
{
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// struct FVector2D               NewDimensions                  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)

void UFullPartyMember_C::UpdateDimensions(struct FVector2D NewDimensions)
{
...
void UFullPartyMember_C::UpdateMemberInfo(struct FFortTeamMemberInfo NewMemberInfo)
{
...
// Function FullPartyMember.FullPartyMember_C.DialogResult
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// EFortDialogResult              Result                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
// struct FName                   ResultName                     (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)

void UFullPartyMember_C::DialogResult(EFortDialogResult Result, struct FName ResultName)
{
	static auto fn = UObject::FindObject<UFunction>("Function FullPartyMember.FullPartyMember_C.DialogResult");

	UFullPartyMember_C_DialogResult_Params params;
	params.Result = Result;
	params.ResultName = ResultName;
