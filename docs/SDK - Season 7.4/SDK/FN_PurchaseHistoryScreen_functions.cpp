...
void UPurchaseHistoryScreen_C::OnInputMethodChanged_Event_1(bool bUsingGamepad)
{
	static auto fn = UObject::FindObject<UFunction>("Function PurchaseHistoryScreen.PurchaseHistoryScreen_C.OnInputMethodChanged_Event_1");

	UPurchaseHistoryScreen_C_OnInputMethodChanged_Event_1_Params params;
