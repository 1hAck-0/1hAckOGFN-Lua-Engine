...
// Function BP_Hex_PARENT.BP_Hex_PARENT_C.Timeline
// (BlueprintEvent)

void ABP_Hex_PARENT_C::Timeline()
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_Hex_PARENT.BP_Hex_PARENT_C.Timeline");

	ABP_Hex_PARENT_C_Timeline_Params params;
...
// Function BP_Hex_PARENT.BP_Hex_PARENT_C.OnLoaded
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// class UObject*                 Loaded                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)

void ABP_Hex_PARENT_C::OnLoaded(class UObject* Loaded)
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_Hex_PARENT.BP_Hex_PARENT_C.OnLoaded");

	ABP_Hex_PARENT_C_OnLoaded_Params params;
...
void ABP_Hex_PARENT_C::MissionLightning(struct FName EventName, float EmitterTime, struct FVector Location, struct FVector Velocity)
{
...
void ABP_Hex_PARENT_C::MissionLightningOff(struct FName EventName, float EmitterTime, int ParticleTime, struct FVector Location, struct FVector Velocity, struct FVector Direction)
{
...
void ABP_Hex_PARENT_C::AsyncUpdateBanner(class UMaterialInstanceDynamic* Material_Instance_Dynamic, struct FUniqueNetIdRepl Unique_Net_Id)
{
...
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_Hex_PARENT.BP_Hex_PARENT_C.RefreshTile");

	ABP_Hex_PARENT_C_RefreshTile_Params params;
