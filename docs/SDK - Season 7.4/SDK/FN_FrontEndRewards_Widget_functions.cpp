...
{
	static auto fn = UObject::FindObject<UFunction>("Function FrontEndRewards_Widget.FrontEndRewards_Widget_C.Play Victory Music");

	UFrontEndRewards_Widget_C_Play_Victory_Music_Params params;
...
// Parameters:
// struct FFrontEndRewards_Definition FrontEndRewards_Definition     (BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, ReferenceParm)
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// struct FFrontEndRewards_Definition Definition                     (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor)

void UFrontEndRewards_Widget_C::InitAdditionalRewards(struct FFrontEndRewards_Definition Definition)
{
...
void UFrontEndRewards_Widget_C::HandleOnCollectionBookRewardsClaimed(struct FFortCollectionBookRewards RewardRequested, bool Success, TArray<struct FFortItemInstanceQuantityPair>* ActualRewards)
{
...
void UFrontEndRewards_Widget_C::InitInitialRewards(struct FFrontEndRewards_Definition Definition)
{
...
// Function FrontEndRewards_Widget.FrontEndRewards_Widget_C.BndEvt__ButtonOpen_K2Node_ComponentBoundEvent
// (BlueprintEvent)
// Parameters:
// class UCommonButton*           Button                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData)

void UFrontEndRewards_Widget_C::BndEvt__ButtonOpen_K2Node_ComponentBoundEvent(class UCommonButton* Button)
{
	static auto fn = UObject::FindObject<UFunction>("Function FrontEndRewards_Widget.FrontEndRewards_Widget_C.BndEvt__ButtonOpen_K2Node_ComponentBoundEvent");

	UFrontEndRewards_Widget_C_BndEvt__ButtonOpen_K2Node_ComponentBoundEvent_Params params;
