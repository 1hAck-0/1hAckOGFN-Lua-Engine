...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass B_CameraLens_Cube_Area.B_CameraLens_Cube_Area_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_B_CameraLens_Cube_Area(int EntryPoint);
};
