...
{
	static auto fn = UObject::FindObject<UFunction>("Function GCN_MiniBoss.GCN_MiniBoss_C.SetMiniBossVisibility");

	AGCN_MiniBoss_C_SetMiniBossVisibility_Params params;
