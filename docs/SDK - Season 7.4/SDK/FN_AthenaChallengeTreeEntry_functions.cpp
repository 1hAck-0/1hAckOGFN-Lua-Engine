...
void UAthenaChallengeTreeEntry_C::SetTimespanSource(TScriptInterface<class UFortTimespanDataSource> Value)
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaChallengeTreeEntry.AthenaChallengeTreeEntry_C.SetTimespanSource");

	UAthenaChallengeTreeEntry_C_SetTimespanSource_Params params;
	params.Value = Value;
