...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaDirectAcquisitionOfferDetailsWidget.AthenaDirectAcquisitionOfferDetailsWidget_C.SetupPurchaseButtonForQuantity");

	UAthenaDirectAcquisitionOfferDetailsWidget_C_SetupPurchaseButtonForQuantity_Params params;
...
int UAthenaDirectAcquisitionOfferDetailsWidget_C::GetNumBattlepassStars()
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaDirectAcquisitionOfferDetailsWidget.AthenaDirectAcquisitionOfferDetailsWidget_C.GetNumBattlepassStars");

	UAthenaDirectAcquisitionOfferDetailsWidget_C_GetNumBattlepassStars_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaDirectAcquisitionOfferDetailsWidget.AthenaDirectAcquisitionOfferDetailsWidget_C.GetHasBattlepassStars");

	UAthenaDirectAcquisitionOfferDetailsWidget_C_GetHasBattlepassStars_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaDirectAcquisitionOfferDetailsWidget.AthenaDirectAcquisitionOfferDetailsWidget_C.ShowHideGiftingButton");

	UAthenaDirectAcquisitionOfferDetailsWidget_C_ShowHideGiftingButton_Params params;
...
int UAthenaDirectAcquisitionOfferDetailsWidget_C::GetOwnedIndex()
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaDirectAcquisitionOfferDetailsWidget.AthenaDirectAcquisitionOfferDetailsWidget_C.GetOwnedIndex");

	UAthenaDirectAcquisitionOfferDetailsWidget_C_GetOwnedIndex_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaDirectAcquisitionOfferDetailsWidget.AthenaDirectAcquisitionOfferDetailsWidget_C.IsNonRefundable");

	UAthenaDirectAcquisitionOfferDetailsWidget_C_IsNonRefundable_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaDirectAcquisitionOfferDetailsWidget.AthenaDirectAcquisitionOfferDetailsWidget_C.DisableGiftButton");

	UAthenaDirectAcquisitionOfferDetailsWidget_C_DisableGiftButton_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaDirectAcquisitionOfferDetailsWidget.AthenaDirectAcquisitionOfferDetailsWidget_C.EnableGiftButton");

	UAthenaDirectAcquisitionOfferDetailsWidget_C_EnableGiftButton_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaDirectAcquisitionOfferDetailsWidget.AthenaDirectAcquisitionOfferDetailsWidget_C.IsDynamicBundle");

	UAthenaDirectAcquisitionOfferDetailsWidget_C_IsDynamicBundle_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaDirectAcquisitionOfferDetailsWidget.AthenaDirectAcquisitionOfferDetailsWidget_C.DoesOfferAllowQuantity");

	UAthenaDirectAcquisitionOfferDetailsWidget_C_DoesOfferAllowQuantity_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaDirectAcquisitionOfferDetailsWidget.AthenaDirectAcquisitionOfferDetailsWidget_C.SetupPurchaseButtonStateAndText");

	UAthenaDirectAcquisitionOfferDetailsWidget_C_SetupPurchaseButtonStateAndText_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaDirectAcquisitionOfferDetailsWidget.AthenaDirectAcquisitionOfferDetailsWidget_C.SetupDynamicBundle");

	UAthenaDirectAcquisitionOfferDetailsWidget_C_SetupDynamicBundle_Params params;
...
void UAthenaDirectAcquisitionOfferDetailsWidget_C::GetSalesText(struct FText* NewParam)
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaDirectAcquisitionOfferDetailsWidget.AthenaDirectAcquisitionOfferDetailsWidget_C.GetSalesText");

	UAthenaDirectAcquisitionOfferDetailsWidget_C_GetSalesText_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaDirectAcquisitionOfferDetailsWidget.AthenaDirectAcquisitionOfferDetailsWidget_C.SetupPrerollItemHeaderInfo");

	UAthenaDirectAcquisitionOfferDetailsWidget_C_SetupPrerollItemHeaderInfo_Params params;
...
struct FText UAthenaDirectAcquisitionOfferDetailsWidget_C::GetDisplayName(struct FFortItemQuantityPair ItemQuantityPair)
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaDirectAcquisitionOfferDetailsWidget.AthenaDirectAcquisitionOfferDetailsWidget_C.GetDisplayName");

	UAthenaDirectAcquisitionOfferDetailsWidget_C_GetDisplayName_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaDirectAcquisitionOfferDetailsWidget.AthenaDirectAcquisitionOfferDetailsWidget_C.GetSortedItems");

	UAthenaDirectAcquisitionOfferDetailsWidget_C_GetSortedItems_Params params;
	...
	if (ItemQuantityPairs != nullptr)
		*ItemQuantityPairs = params.ItemQuantityPairs;
}
...
bool UAthenaDirectAcquisitionOfferDetailsWidget_C::IsItemDefOwned(class UFortItemDefinition* ItemDef)
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaDirectAcquisitionOfferDetailsWidget.AthenaDirectAcquisitionOfferDetailsWidget_C.IsItemDefOwned");

	UAthenaDirectAcquisitionOfferDetailsWidget_C_IsItemDefOwned_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaDirectAcquisitionOfferDetailsWidget.AthenaDirectAcquisitionOfferDetailsWidget_C.UpdateDetails");

	UAthenaDirectAcquisitionOfferDetailsWidget_C_UpdateDetails_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaDirectAcquisitionOfferDetailsWidget.AthenaDirectAcquisitionOfferDetailsWidget_C.GetPagingVisibility");

	UAthenaDirectAcquisitionOfferDetailsWidget_C_GetPagingVisibility_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaDirectAcquisitionOfferDetailsWidget.AthenaDirectAcquisitionOfferDetailsWidget_C.GetOfferDetailsSlotMargin");

	UAthenaDirectAcquisitionOfferDetailsWidget_C_GetOfferDetailsSlotMargin_Params params;
...
void UAthenaDirectAcquisitionOfferDetailsWidget_C::CreateAndAddRewardItem(struct FFortItemQuantityPair ItemQuantity, int ItemIndex, TArray<struct FFortItemQuantityPair>* SortedItemQuantities)
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaDirectAcquisitionOfferDetailsWidget.AthenaDirectAcquisitionOfferDetailsWidget_C.CreateAndAddRewardItem");

	UAthenaDirectAcquisitionOfferDetailsWidget_C_CreateAndAddRewardItem_Params params;
	...
	if (SortedItemQuantities != nullptr)
		*SortedItemQuantities = params.SortedItemQuantities;
}
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaDirectAcquisitionOfferDetailsWidget.AthenaDirectAcquisitionOfferDetailsWidget_C.GetShowDescription");

	UAthenaDirectAcquisitionOfferDetailsWidget_C_GetShowDescription_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaDirectAcquisitionOfferDetailsWidget.AthenaDirectAcquisitionOfferDetailsWidget_C.GetShowDetails");

	UAthenaDirectAcquisitionOfferDetailsWidget_C_GetShowDetails_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaDirectAcquisitionOfferDetailsWidget.AthenaDirectAcquisitionOfferDetailsWidget_C.GetShowCard");

	UAthenaDirectAcquisitionOfferDetailsWidget_C_GetShowCard_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaDirectAcquisitionOfferDetailsWidget.AthenaDirectAcquisitionOfferDetailsWidget_C.GetCardSize");

	UAthenaDirectAcquisitionOfferDetailsWidget_C_GetCardSize_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaDirectAcquisitionOfferDetailsWidget.AthenaDirectAcquisitionOfferDetailsWidget_C.IsSingleGrantedItem");

	UAthenaDirectAcquisitionOfferDetailsWidget_C_IsSingleGrantedItem_Params params;
...
void UAthenaDirectAcquisitionOfferDetailsWidget_C::Owned_Bundle_Item_Count(int* Owned_Items, int* UnOwned_Items, bool* bNoneOwned, bool* bAllOwned)
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaDirectAcquisitionOfferDetailsWidget.AthenaDirectAcquisitionOfferDetailsWidget_C.Owned Bundle Item Count");

	UAthenaDirectAcquisitionOfferDetailsWidget_C_Owned_Bundle_Item_Count_Params params;
	...
	if (UnOwned_Items != nullptr)
		*UnOwned_Items = params.UnOwned_Items;
	if (bNoneOwned != nullptr)
		*bNoneOwned = params.bNoneOwned;
	if (bAllOwned != nullptr)
		*bAllOwned = params.bAllOwned;
}
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaDirectAcquisitionOfferDetailsWidget.AthenaDirectAcquisitionOfferDetailsWidget_C.UpdateFromOffer_RefreshButtons");

	UAthenaDirectAcquisitionOfferDetailsWidget_C_UpdateFromOffer_RefreshButtons_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaDirectAcquisitionOfferDetailsWidget.AthenaDirectAcquisitionOfferDetailsWidget_C.CanGiftOffer");

	UAthenaDirectAcquisitionOfferDetailsWidget_C_CanGiftOffer_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaDirectAcquisitionOfferDetailsWidget.AthenaDirectAcquisitionOfferDetailsWidget_C.HandleGetVBucksClicked");

	UAthenaDirectAcquisitionOfferDetailsWidget_C_HandleGetVBucksClicked_Params params;
...
void UAthenaDirectAcquisitionOfferDetailsWidget_C::FixupBackpack(class UFortItemDefinition* ItemDef, class UAthenaSeasonReward_C* RewardWidget, TArray<struct FFortItemQuantityPair>* AllItemQuantityPairs)
{
	...
	if (AllItemQuantityPairs != nullptr)
		*AllItemQuantityPairs = params.AllItemQuantityPairs;
}
...
void UAthenaDirectAcquisitionOfferDetailsWidget_C::SetupSaleInfo(bool bHasSale, struct FString BannerOverrideTag, struct FText NormalPrice, bool bHasBattlePassStars, int NumOfBattlePassStars)
{
...
void UAthenaDirectAcquisitionOfferDetailsWidget_C::DialogResult(EFortDialogResult Result, struct FName ResultName)
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaDirectAcquisitionOfferDetailsWidget.AthenaDirectAcquisitionOfferDetailsWidget_C.DialogResult");

	UAthenaDirectAcquisitionOfferDetailsWidget_C_DialogResult_Params params;
...
void UAthenaDirectAcquisitionOfferDetailsWidget_C::BndEvt__PurchaseButton_K2Node_ComponentBoundEvent(class UCommonButton* Button)
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaDirectAcquisitionOfferDetailsWidget.AthenaDirectAcquisitionOfferDetailsWidget_C.BndEvt__PurchaseButton_K2Node_ComponentBoundEvent");

	UAthenaDirectAcquisitionOfferDetailsWidget_C_BndEvt__PurchaseButton_K2Node_ComponentBoundEvent_Params params;
...
void UAthenaDirectAcquisitionOfferDetailsWidget_C::BndEvt__Button_Next_K2Node_ComponentBoundEvent(class UCommonButton* Button)
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaDirectAcquisitionOfferDetailsWidget.AthenaDirectAcquisitionOfferDetailsWidget_C.BndEvt__Button_Next_K2Node_ComponentBoundEvent");

	UAthenaDirectAcquisitionOfferDetailsWidget_C_BndEvt__Button_Next_K2Node_ComponentBoundEvent_Params params;
	params.Button = Button;
...
void UAthenaDirectAcquisitionOfferDetailsWidget_C::BndEvt__Button_Previous_K2Node_ComponentBoundEvent(class UCommonButton* Button)
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaDirectAcquisitionOfferDetailsWidget.AthenaDirectAcquisitionOfferDetailsWidget_C.BndEvt__Button_Previous_K2Node_ComponentBoundEvent");

	UAthenaDirectAcquisitionOfferDetailsWidget_C_BndEvt__Button_Previous_K2Node_ComponentBoundEvent_Params params;
	params.Button = Button;
...
void UAthenaDirectAcquisitionOfferDetailsWidget_C::BndEvt__GiftButton_K2Node_ComponentBoundEvent(class UCommonButton* Button)
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaDirectAcquisitionOfferDetailsWidget.AthenaDirectAcquisitionOfferDetailsWidget_C.BndEvt__GiftButton_K2Node_ComponentBoundEvent");

	UAthenaDirectAcquisitionOfferDetailsWidget_C_BndEvt__GiftButton_K2Node_ComponentBoundEvent_Params params;
	params.Button = Button;
...
// Function AthenaDirectAcquisitionOfferDetailsWidget.AthenaDirectAcquisitionOfferDetailsWidget_C.BndEvt__PanelButton_K2Node_ComponentBoundEvent
// (BlueprintEvent)
// Parameters:
// class UCommonButton*           Button                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData)

void UAthenaDirectAcquisitionOfferDetailsWidget_C::BndEvt__PanelButton_K2Node_ComponentBoundEvent(class UCommonButton* Button)
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaDirectAcquisitionOfferDetailsWidget.AthenaDirectAcquisitionOfferDetailsWidget_C.BndEvt__PanelButton_K2Node_ComponentBoundEvent");

	UAthenaDirectAcquisitionOfferDetailsWidget_C_BndEvt__PanelButton_K2Node_ComponentBoundEvent_Params params;
	params.Button = Button;
...
void UAthenaDirectAcquisitionOfferDetailsWidget_C::BndEvt__SwipePanel_K2Node_ComponentBoundEvent()
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaDirectAcquisitionOfferDetailsWidget.AthenaDirectAcquisitionOfferDetailsWidget_C.BndEvt__SwipePanel_K2Node_ComponentBoundEvent");

	UAthenaDirectAcquisitionOfferDetailsWidget_C_BndEvt__SwipePanel_K2Node_ComponentBoundEvent_Params params;
...
void UAthenaDirectAcquisitionOfferDetailsWidget_C::BndEvt__PreviewStylesButton_K2Node_ComponentBoundEvent(class UCommonButton* Button)
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaDirectAcquisitionOfferDetailsWidget.AthenaDirectAcquisitionOfferDetailsWidget_C.BndEvt__PreviewStylesButton_K2Node_ComponentBoundEvent");

	UAthenaDirectAcquisitionOfferDetailsWidget_C_BndEvt__PreviewStylesButton_K2Node_ComponentBoundEvent_Params params;
	params.Button = Button;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaDirectAcquisitionOfferDetailsWidget.AthenaDirectAcquisitionOfferDetailsWidget_C.DelayGiftTimerUp");

	UAthenaDirectAcquisitionOfferDetailsWidget_C_DelayGiftTimerUp_Params params;
...
void UAthenaDirectAcquisitionOfferDetailsWidget_C::WidgetAnimationEvt_Intro_K2Node_WidgetAnimationEvent_1()
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaDirectAcquisitionOfferDetailsWidget.AthenaDirectAcquisitionOfferDetailsWidget_C.WidgetAnimationEvt_Intro_K2Node_WidgetAnimationEvent_1");

	UAthenaDirectAcquisitionOfferDetailsWidget_C_WidgetAnimationEvt_Intro_K2Node_WidgetAnimationEvent_1_Params params;
...
void UAthenaDirectAcquisitionOfferDetailsWidget_C::BndEvt__PageRightBtn_K2Node_ComponentBoundEvent(class UCommonButton* Button)
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaDirectAcquisitionOfferDetailsWidget.AthenaDirectAcquisitionOfferDetailsWidget_C.BndEvt__PageRightBtn_K2Node_ComponentBoundEvent");

	UAthenaDirectAcquisitionOfferDetailsWidget_C_BndEvt__PageRightBtn_K2Node_ComponentBoundEvent_Params params;
	params.Button = Button;
...
void UAthenaDirectAcquisitionOfferDetailsWidget_C::BndEvt__PageLeftBtn_K2Node_ComponentBoundEvent(class UCommonButton* Button)
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaDirectAcquisitionOfferDetailsWidget.AthenaDirectAcquisitionOfferDetailsWidget_C.BndEvt__PageLeftBtn_K2Node_ComponentBoundEvent");

	UAthenaDirectAcquisitionOfferDetailsWidget_C_BndEvt__PageLeftBtn_K2Node_ComponentBoundEvent_Params params;
	params.Button = Button;
