...
void UToastWidget_New_C::ShowText(struct FText Text, class UCommonTextBlock* TextBlock)
{
...
// Function ToastWidget_New.ToastWidget_New_C.BndEvt__OpenButton_K2Node_ComponentBoundEvent
// (BlueprintEvent)
// Parameters:
// class UCommonButton*           Button                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData)

void UToastWidget_New_C::BndEvt__OpenButton_K2Node_ComponentBoundEvent(class UCommonButton* Button)
{
	static auto fn = UObject::FindObject<UFunction>("Function ToastWidget_New.ToastWidget_New_C.BndEvt__OpenButton_K2Node_ComponentBoundEvent");

	UToastWidget_New_C_BndEvt__OpenButton_K2Node_ComponentBoundEvent_Params params;
