...
struct FProfileUpdateNotification
{
	...
	struct FDateTime                                   LockExpiration;                                           // 0x0010(0x0008) (ZeroConstructor)
...
struct FProfileUpdate : public FProfileUpdateSingle
{
	...
	struct FDateTime                                   ServerTime;                                               // 0x0058(0x0008) (ZeroConstructor)
...
struct FGiftBoxInfo
{
	struct FDateTime                                   GiftedOn;                                                 // 0x0000(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
