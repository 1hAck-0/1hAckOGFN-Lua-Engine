...
{
	static auto fn = UObject::FindObject<UFunction>("Function DA_Glider_Item.DA_Glider_Item_C.UserConstructionScript");

	ADA_Glider_Item_C_UserConstructionScript_Params params;
