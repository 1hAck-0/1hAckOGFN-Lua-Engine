...
{
	static auto fn = UObject::FindObject<UFunction>("Function GCNL_Ninja_DragonSlash.GCNL_Ninja_DragonSlash_C.UserConstructionScript");

	AGCNL_Ninja_DragonSlash_C_UserConstructionScript_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function GCNL_Ninja_DragonSlash.GCNL_Ninja_DragonSlash_C.OnLoopingStart");

	AGCNL_Ninja_DragonSlash_C_OnLoopingStart_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function GCNL_Ninja_DragonSlash.GCNL_Ninja_DragonSlash_C.OnRemoval");

	AGCNL_Ninja_DragonSlash_C_OnRemoval_Params params;
	params.MyTarget = MyTarget;
	params.Parameters = Parameters;
	params.ParticleComponents = ParticleComponents;
	params.AudioComponents = AudioComponents;
...
void AGCNL_Ninja_DragonSlash_C::ExecuteUbergraph_GCNL_Ninja_DragonSlash(int EntryPoint)
{
	static auto fn = UObject::FindObject<UFunction>("Function GCNL_Ninja_DragonSlash.GCNL_Ninja_DragonSlash_C.ExecuteUbergraph_GCNL_Ninja_DragonSlash");

	AGCNL_Ninja_DragonSlash_C_ExecuteUbergraph_GCNL_Ninja_DragonSlash_Params params;
