...
void UQuestInfo_BulletList_C::AddEntryWithBrush(struct FText EntryText, struct FSlateBrush EntryIconBrush)
{
...
void UQuestInfo_BulletList_C::AddEntry(struct FText EntryText)
{
