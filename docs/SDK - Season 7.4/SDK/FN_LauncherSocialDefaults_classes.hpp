...
{
public:
	struct FChatMarkupStyle                            Style;                                                    // 0x0030(0x0690) (Edit)
...
{
public:
	struct FChatStyle                                  Style;                                                    // 0x0030(0x1360) (Edit)
...
{
public:
	struct FSocialFontStyle                            Style;                                                    // 0x0030(0x0210) (Edit)
...
{
public:
	struct FSocialListStyle                            Style;                                                    // 0x0030(0x26F8) (Edit)
