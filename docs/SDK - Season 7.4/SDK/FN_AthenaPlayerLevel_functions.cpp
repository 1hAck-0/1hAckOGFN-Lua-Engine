...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaPlayerLevel.AthenaPlayerLevel_C.AnimateBar");

	UAthenaPlayerLevel_C_AnimateBar_Params params;
...
void UAthenaPlayerLevel_C::InitializeFromLevelInfo(struct FAthenaLevelInfo LevelInfo)
{
...
// Function AthenaPlayerLevel.AthenaPlayerLevel_C.WidgetAnimationEvt_AnimateXp_K2Node_WidgetAnimationEvent_1
// (BlueprintEvent)

void UAthenaPlayerLevel_C::WidgetAnimationEvt_AnimateXp_K2Node_WidgetAnimationEvent_1()
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaPlayerLevel.AthenaPlayerLevel_C.WidgetAnimationEvt_AnimateXp_K2Node_WidgetAnimationEvent_1");

	UAthenaPlayerLevel_C_WidgetAnimationEvt_AnimateXp_K2Node_WidgetAnimationEvent_1_Params params;
...
// Function AthenaPlayerLevel.AthenaPlayerLevel_C.WidgetAnimationEvt_AnimateXpAndLevel_K2Node_WidgetAnimationEvent_2
// (BlueprintEvent)

void UAthenaPlayerLevel_C::WidgetAnimationEvt_AnimateXpAndLevel_K2Node_WidgetAnimationEvent_2()
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaPlayerLevel.AthenaPlayerLevel_C.WidgetAnimationEvt_AnimateXpAndLevel_K2Node_WidgetAnimationEvent_2");

	UAthenaPlayerLevel_C_WidgetAnimationEvt_AnimateXpAndLevel_K2Node_WidgetAnimationEvent_2_Params params;
