...
void UBannerLibrary_C::STATIC_UpdateBannerColorOnMaterial(class UMaterialInstanceDynamic* Material, struct FLinearColor PrimaryBGColor, struct FLinearColor SecondaryBGColor, class UObject* __WorldContext)
{
...
void UBannerLibrary_C::STATIC_GenericUpdateMaterial(class UMaterialInstanceDynamic* Target, class UTexture* BannerIcon, struct FLinearColor BG_PrimaryColor, struct FLinearColor BG_SecondaryColor, class UTexture* ShapeIcon, class UObject* __WorldContext)
{
