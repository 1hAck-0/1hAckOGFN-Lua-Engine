...
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass PlayerNameDropdown.PlayerNameDropdown_C");
		return ptr;
	}
	...
	void Construct();
	void OnActivated();
	void ExecuteUbergraph_PlayerNameDropdown(int EntryPoint);
};
