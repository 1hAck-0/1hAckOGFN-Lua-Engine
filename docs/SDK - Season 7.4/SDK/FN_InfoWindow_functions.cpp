...
void UInfoWindow_C::AddInfo(struct FText Title, TArray<class UFortItemDefinition*>* Info_Items)
{
...
void UInfoWindow_C::BndEvt__IconTextButton_K2Node_ComponentBoundEvent(class UCommonButton* Button)
{
	static auto fn = UObject::FindObject<UFunction>("Function InfoWindow.InfoWindow_C.BndEvt__IconTextButton_K2Node_ComponentBoundEvent");

	UInfoWindow_C_BndEvt__IconTextButton_K2Node_ComponentBoundEvent_Params params;
...
void UInfoWindow_C::BndEvt__Lightbox_K2Node_ComponentBoundEvent()
{
	static auto fn = UObject::FindObject<UFunction>("Function InfoWindow.InfoWindow_C.BndEvt__Lightbox_K2Node_ComponentBoundEvent");

	UInfoWindow_C_BndEvt__Lightbox_K2Node_ComponentBoundEvent_Params params;
...
void UInfoWindow_C::BndEvt__InfoButtons_K2Node_ComponentBoundEvent(class UUserWidget* Widget)
{
	static auto fn = UObject::FindObject<UFunction>("Function InfoWindow.InfoWindow_C.BndEvt__InfoButtons_K2Node_ComponentBoundEvent");

	UInfoWindow_C_BndEvt__InfoButtons_K2Node_ComponentBoundEvent_Params params;
