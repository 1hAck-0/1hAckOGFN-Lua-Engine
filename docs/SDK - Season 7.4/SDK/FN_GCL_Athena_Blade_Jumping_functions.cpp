...
{
	static auto fn = UObject::FindObject<UFunction>("Function GCL_Athena_Blade_Jumping.GCL_Athena_Blade_Jumping_C.UserConstructionScript");

	AGCL_Athena_Blade_Jumping_C_UserConstructionScript_Params params;
