...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass B_CameraLens_Teleport.B_CameraLens_Teleport_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_B_CameraLens_Teleport(int EntryPoint);
};
