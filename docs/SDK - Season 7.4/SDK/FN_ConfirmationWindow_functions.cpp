...
{
	static auto fn = UObject::FindObject<UFunction>("Function ConfirmationWindow.ConfirmationWindow_C.PlayShowSound");
...
struct FEventReply UConfirmationWindow_C::TapToClose(struct FGeometry MyGeometry, struct FPointerEvent MouseEvent)
{
...
void UConfirmationWindow_C::OnWaitForExternalLatentAction(struct FFortDialogExternalLatentActionHandle LatentActionHandle)
{
...
struct FDataTableRowHandle UConfirmationWindow_C::GetInputAction(struct FName RowName, bool UseInputAction)
{
...
void UConfirmationWindow_C::AddSingleConfirmButton(struct FConfirmationDialogAction ConfirmDialogAction, bool UseInputAction)
{
...
void UConfirmationWindow_C::SetDescription(struct FFortDialogDescription_NUI NewDescription)
{
