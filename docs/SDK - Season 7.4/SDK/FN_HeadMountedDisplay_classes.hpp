...
public:
	...
	EControllerHand                                    Hand;                                                     // 0x0574(0x0001) (BlueprintVisible, ZeroConstructor, Deprecated, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0575(0x0003) MISSED OFFSET
	struct FName                                       MotionSource;                                             // 0x0578(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bDisableLowLatencyUpdate : 1;                             // 0x0580(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0581(0x0003) MISSED OFFSET
	ETrackingStatus                                    CurrentTrackingStatus;                                    // 0x0584(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               bDisplayDeviceModel;                                      // 0x0585(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x2];                                       // 0x0586(0x0002) MISSED OFFSET
	struct FName                                       DisplayModelSource;                                       // 0x0588(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UStaticMesh*                                 CustomDisplayMesh;                                        // 0x0590(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TArray<class UMaterialInterface*>                  DisplayMeshMaterialOverrides;                             // 0x0598(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	unsigned char                                      UnknownData03[0x68];                                      // 0x05A8(0x0068) MISSED OFFSET
	...
	unsigned char                                      UnknownData04[0x18];                                      // 0x0618(0x0018) MISSED OFFSET
...
{
public:
	unsigned char                                      UnknownData00[0x10];                                      // 0x00F8(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty HeadMountedDisplay.VRNotificationsComponent.HMDTrackingInitializingAndNeedsHMDToBeTrackedDelegate
	unsigned char                                      UnknownData01[0x10];                                      // 0x0108(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty HeadMountedDisplay.VRNotificationsComponent.HMDTrackingInitializedDelegate
	unsigned char                                      UnknownData02[0x10];                                      // 0x0118(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty HeadMountedDisplay.VRNotificationsComponent.HMDRecenteredDelegate
	unsigned char                                      UnknownData03[0x10];                                      // 0x0128(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty HeadMountedDisplay.VRNotificationsComponent.HMDLostDelegate
	unsigned char                                      UnknownData04[0x10];                                      // 0x0138(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty HeadMountedDisplay.VRNotificationsComponent.HMDReconnectedDelegate
	unsigned char                                      UnknownData05[0x10];                                      // 0x0148(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty HeadMountedDisplay.VRNotificationsComponent.HMDConnectCanceledDelegate
	unsigned char                                      UnknownData06[0x10];                                      // 0x0158(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty HeadMountedDisplay.VRNotificationsComponent.HMDPutOnHeadDelegate
	unsigned char                                      UnknownData07[0x10];                                      // 0x0168(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty HeadMountedDisplay.VRNotificationsComponent.HMDRemovedFromHeadDelegate
	unsigned char                                      UnknownData08[0x10];                                      // 0x0178(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty HeadMountedDisplay.VRNotificationsComponent.VRControllerRecenteredDelegate
...
{
public:
	unsigned char                                      UnknownData00[0x10];                                      // 0x0030(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty HeadMountedDisplay.AsyncTask_LoadXRDeviceVisComponent.OnModelLoaded
	unsigned char                                      UnknownData01[0x10];                                      // 0x0040(0x0010) UNKNOWN PROPERTY: MulticastDelegateProperty HeadMountedDisplay.AsyncTask_LoadXRDeviceVisComponent.OnLoadFailure
