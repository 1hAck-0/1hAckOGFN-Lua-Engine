...
struct AGC_Outlander_Phaseshift_PhaseSiphon_Dash_C_UserConstructionScript_Params
{
};

// Function GC_Outlander_Phaseshift_PhaseSiphon_Dash.GC_Outlander_Phaseshift_PhaseSiphon_Dash_C.ReceiveBeginPlay
struct AGC_Outlander_Phaseshift_PhaseSiphon_Dash_C_ReceiveBeginPlay_Params
{
};
