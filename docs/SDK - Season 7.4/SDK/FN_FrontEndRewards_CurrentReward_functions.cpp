...
{
	static auto fn = UObject::FindObject<UFunction>("Function FrontEndRewards_CurrentReward.FrontEndRewards_CurrentReward_C.Destruct");

	UFrontEndRewards_CurrentReward_C_Destruct_Params params;
