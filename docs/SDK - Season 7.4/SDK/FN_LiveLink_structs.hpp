...
{
	struct FName                                       SubjectName;                                              // 0x0010(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UClass*                                      RetargetAsset;                                            // 0x0018(0x0008) (Edit, BlueprintVisible, ZeroConstructor, NoClear, IsPlainOldData)
	class ULiveLinkRetargetAsset*                      CurrentRetargetAsset;                                     // 0x0020(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
...
{
	struct FMovieSceneLiveLinkTemplateData             TemplateData;                                             // 0x0048(0x00C8)
};
