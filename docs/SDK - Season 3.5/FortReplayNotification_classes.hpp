...
public:
	...
	class UCommonTextBlock*                      Notification;                                      // 0x228(0x8)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	float                                        TimeToDisplay;                                     // 0x230(0x4)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                        FadeInterpSpeed;                                   // 0x234(0x4)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         IsFading;                                          // 0x238(0x1)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	uint8                                        Pad_4870[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	float                                        RemainingTime;                                     // 0x23C(0x4)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class FText                                  FullyVisible;                                      // 0x240(0x18)(Edit, BlueprintVisible, DisableEditOnInstance)
	class FText                                  FullyHidden;                                       // 0x258(0x18)(Edit, BlueprintVisible, DisableEditOnInstance)
	class FText                                  GameOnly;                                          // 0x270(0x18)(Edit, BlueprintVisible, DisableEditOnInstance)
	class FText                                  ReplayOnly;                                        // 0x288(0x18)(Edit, BlueprintVisible, DisableEditOnInstance)
	enum class ESlateVisibility                  PendingVisibility;                                 // 0x2A0(0x1)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
