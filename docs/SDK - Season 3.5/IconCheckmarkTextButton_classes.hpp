...
public:
	...
	class UImage*                                Checkmark;                                         // 0x818(0x8)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	enum class EHorizontalAlignment              ContentAlignment;                                  // 0x8E8(0x1)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         bMouseKeyboardStyleSet;                            // 0x8E9(0x1)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	uint8                                        Pad_49CA[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class FText                                  OverrideButtonText;                                // 0x8F0(0x18)(Edit, BlueprintVisible, DisableEditOnInstance)
	struct FSlateBrush                           CheckBrush;                                        // 0x908(0x88)(Edit, BlueprintVisible)
	struct FSlateBrush                           UncheckBrush;                                      // 0x990(0x88)(Edit, BlueprintVisible)

	static class UClass* StaticClass()
	{
		static class UClass* Clss = UObject::FindClassFast("IconCheckmarkTextButton_C");
		return Clss;
	}
