...
public:
	...
	struct FFormatArgumentData                   K2Node_MakeStruct_FormatArgumentData12;            // 0x180(0x40)(HasGetValueTypeHash)
	struct FFormatArgumentData                   K2Node_MakeStruct_FormatArgumentData123;           // 0x1C0(0x40)(HasGetValueTypeHash)
	TArray<struct FFormatArgumentData>           K2Node_MakeArray_Array12;                          // 0x200(0x10)(ZeroConstructor, ReferenceParm)
