...
public:
	...
	uint8                                        Pad_4099[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	class UWidget*                               K2Node_ComponentBoundEvent_ActiveWidget;           // 0x30(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                         CallFunc_IsValid_ReturnValue12;                    // 0x3E(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
