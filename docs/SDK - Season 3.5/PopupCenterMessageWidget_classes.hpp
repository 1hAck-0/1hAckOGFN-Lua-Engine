...
public:
	...
	class UPopupCenterMessageModalPanel_C*       CenterPopupModal;                                  // 0x258(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FTimerHandle                          UpdateStateTimer;                                  // 0x260(0x8)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor)
