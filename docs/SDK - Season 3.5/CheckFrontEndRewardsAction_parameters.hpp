...
public:
	...
	uint8                                        Pad_4427[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	TArray<class UFortExpeditionItem*>           K2Node_MakeArray_Array1;                           // 0x10(0x10)(ZeroConstructor, ReferenceParm)
	TArray<class UFortQuestItem*>                K2Node_MakeArray_Array12;                          // 0x20(0x10)(ZeroConstructor, ReferenceParm)
	TArray<class UFortQuestItem*>                K2Node_MakeArray_Array123;                         // 0x30(0x10)(ZeroConstructor, ReferenceParm)
	struct FFrontEndRewards_Definition           K2Node_MakeStruct_FrontEndRewards_Definition;      // 0x40(0x4A)(HasGetValueTypeHash)
	uint8                                        Pad_442B[0x6];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_4432[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
