...
void UTabGamePadConfig_C::HandleGamepadMappingInfoChange(TSoftObjectPtr<class UTexture2D> CallFunc_Conv_ObjectToSoftObjectReference_ReturnValue, TSoftObjectPtr<class UTexture2D> CallFunc_Conv_ObjectToSoftObjectReference_ReturnValue1, int32 Temp_int_Variable, bool CallFunc_IsCustomConfig_ReturnValue, TSoftObjectPtr<class UTexture2D> K2Node_Select_Default, int32 CallFunc_Conv_BoolToInt_ReturnValue)
{
	...
	Parms.CallFunc_Conv_ObjectToSoftObjectReference_ReturnValue1 = CallFunc_Conv_ObjectToSoftObjectReference_ReturnValue1;
	Parms.Temp_int_Variable = Temp_int_Variable;
...
{
	static auto Func = Class->GetFunction("TabGamePadConfig_C", "Unclicked_Bind");

	Params::UTabGamePadConfig_C_Unclicked_Bind_Params Parms;
	Parms.Number_in_List = Number_in_List;
	Parms.Widget = Widget;
