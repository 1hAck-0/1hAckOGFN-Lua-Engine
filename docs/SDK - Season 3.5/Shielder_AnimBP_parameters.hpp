...
public:
	...
	uint8                                        Pad_D38[0x2];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	class AShielderPawn_C*                       K2Node_DynamicCast_AsShielder_Pawn;                // 0x38(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	enum class EFortMovementStyle                CallFunc_GetMovementStyle_ReturnValue;             // 0x58(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
