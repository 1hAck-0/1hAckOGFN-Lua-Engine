...
void AB_Pickups_C::SetVisibleMobileInteractIcon(bool Visible, bool CallFunc_IsValid_ReturnValue, bool CallFunc_IsValid_ReturnValue1, float CallFunc_Multiply_FloatFloat_ReturnValue, bool CallFunc_IsValid_ReturnValue12, const struct FRotator& CallFunc_MakeRotator_ReturnValue, const struct FTransform& CallFunc_MakeTransform_ReturnValue, class UStaticMeshComponent* CallFunc_AddComponent_ReturnValue)
{
	static auto Func = Class->GetFunction("B_Pickups_C", "SetVisibleMobileInteractIcon");

	Params::AB_Pickups_C_SetVisibleMobileInteractIcon_Params Parms;
...
void AB_Pickups_C::SetInitialBGRaysParams(class UMaterialInstanceDynamic* Mid, bool CallFunc_GreaterEqual_IntInt_ReturnValue, float CallFunc_Multiply_FloatFloat_ReturnValue, float CallFunc_RandomFloatInRange_ReturnValue)
{
	static auto Func = Class->GetFunction("B_Pickups_C", "SetInitialBGRaysParams");

	Params::AB_Pickups_C_SetInitialBGRaysParams_Params Parms;
	Parms.Mid = Mid;
...
void AB_Pickups_C::SetActiveBackgroundParticleSystem(bool Active, bool Reset, bool CallFunc_IsValid_ReturnValue)
{
	static auto Func = Class->GetFunction("B_Pickups_C", "SetActiveBackgroundParticleSystem");

	Params::AB_Pickups_C_SetActiveBackgroundParticleSystem_Params Parms;
	Parms.Active = Active;
	Parms.Reset = Reset;
	Parms.CallFunc_IsValid_ReturnValue = CallFunc_IsValid_ReturnValue;
...
void AB_Pickups_C::SetInitialHologramParams(class UMaterialInstanceDynamic* Mid, float CallFunc_RandomFloatInRange_ReturnValue, float CallFunc_Array_Get_Item, float CallFunc_Array_Get_Item1)
{
	static auto Func = Class->GetFunction("B_Pickups_C", "SetInitialHologramParams");

	Params::AB_Pickups_C_SetInitialHologramParams_Params Parms;
	Parms.Mid = Mid;
	Parms.CallFunc_RandomFloatInRange_ReturnValue = CallFunc_RandomFloatInRange_ReturnValue;
...
// class UMaterialInstanceDynamic*    CallFunc_Array_Get_Item12345                                     (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// int32                              Temp_int_Loop_Counter_Variable                                   (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                               CallFunc_Less_IntInt_ReturnValue                                 (ZeroConstructor, IsPlainOldData, NoDestructor)
// int32                              CallFunc_Add_IntInt_ReturnValue                                  (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void AB_Pickups_C::SetupStretchMIDs(const struct FGameplayTagContainer& NewLocalVar_0, int32 CallFunc_Array_Length_ReturnValue, class UMaterialInterface* CallFunc_Array_Get_Item, class UMaterialInterface* Temp_object_Variable, bool CallFunc_Array_IsValidIndex_ReturnValue, int32 Temp_int_Array_Index_Variable, bool Temp_bool_Variable, class UMaterialInterface* K2Node_Select_Default, bool CallFunc_GetPickupStretchMIDFromPool_bNeedsToBeInitialized, class UMaterialInstanceDynamic* CallFunc_GetPickupStretchMIDFromPool_ReturnValue, class UMaterialInstanceDynamic* CallFunc_Array_Get_Item1, bool CallFunc_IsValid_ReturnValue, class UMaterialInterface* CallFunc_Array_Get_Item12, class UMaterialInstanceDynamic* CallFunc_Array_Get_Item123, class UMaterialInstanceDynamic* CallFunc_CreateDynamicMaterialInstance_ReturnValue, class UMaterialInterface* CallFunc_Array_Get_Item1234, class UMaterialInstanceDynamic* CallFunc_Array_Get_Item12345, int32 Temp_int_Loop_Counter_Variable, bool CallFunc_Less_IntInt_ReturnValue, int32 CallFunc_Add_IntInt_ReturnValue)
{
	static auto Func = Class->GetFunction("B_Pickups_C", "SetupStretchMIDs");

	Params::AB_Pickups_C_SetupStretchMIDs_Params Parms;
...
void AB_Pickups_C::SetupBaseMIDs(int32 Temp_int_Array_Index_Variable, int32 Temp_int_Loop_Counter_Variable, int32 CallFunc_Add_IntInt_ReturnValue, bool CallFunc_BooleanOR_ReturnValue, bool CallFunc_BooleanOR_ReturnValue1, class UMaterialInterface* CallFunc_Array_Get_Item, class UMaterial* CallFunc_GetBaseMaterial_ReturnValue, class UMaterialInterface* CallFunc_GetMaterial_ReturnValue, int32 CallFunc_Array_Length_ReturnValue, bool CallFunc_Less_IntInt_ReturnValue)
{
	static auto Func = Class->GetFunction("B_Pickups_C", "SetupBaseMIDs");

	Params::AB_Pickups_C_SetupBaseMIDs_Params Parms;
	Parms.Temp_int_Array_Index_Variable = Temp_int_Array_Index_Variable;
	Parms.Temp_int_Loop_Counter_Variable = Temp_int_Loop_Counter_Variable;
	Parms.CallFunc_Add_IntInt_ReturnValue = CallFunc_Add_IntInt_ReturnValue;
...
{
	static auto Func = Class->GetFunction("B_Pickups_C", "SetHiddenBackgroundVisualComponents");

	Params::AB_Pickups_C_SetHiddenBackgroundVisualComponents_Params Parms;
	Parms.Hidden = Hidden;
	Parms.CallFunc_IsValid_ReturnValue = CallFunc_IsValid_ReturnValue;
	Parms.CallFunc_IsValid_ReturnValue1 = CallFunc_IsValid_ReturnValue1;
...
void AB_Pickups_C::SetupLight(bool CallFunc_EqualEqual_IntInt_ReturnValue, class UGameUserSettings* CallFunc_GetGameUserSettings_ReturnValue, bool CallFunc_IsMobilePlatform_ReturnValue, int32 CallFunc_GetVisualEffectQuality_ReturnValue, bool CallFunc_BooleanOR_ReturnValue, bool K2Node_SwitchInteger_CmpSuccess)
{
	static auto Func = Class->GetFunction("B_Pickups_C", "SetupLight");

	Params::AB_Pickups_C_SetupLight_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_Pickups_C", "DestroyBackgroundVisualComponents");

	Params::AB_Pickups_C_DestroyBackgroundVisualComponents_Params Parms;
	Parms.CallFunc_IsValid_ReturnValue = CallFunc_IsValid_ReturnValue;
	Parms.CallFunc_IsValid_ReturnValue1 = CallFunc_IsValid_ReturnValue1;
...
{
	static auto Func = Class->GetFunction("B_Pickups_C", "ReleaseStretchMIDs");

	Params::AB_Pickups_C_ReleaseStretchMIDs_Params Parms;
	Parms.Temp_int_Array_Index_Variable = Temp_int_Array_Index_Variable;
	Parms.Temp_int_Loop_Counter_Variable = Temp_int_Loop_Counter_Variable;
	Parms.CallFunc_Add_IntInt_ReturnValue = CallFunc_Add_IntInt_ReturnValue;
	Parms.CallFunc_Array_Get_Item = CallFunc_Array_Get_Item;
...
void AB_Pickups_C::ScaleHologramTimingsForPvP(float PVP_TimeScale, float CallFunc_Multiply_FloatFloat_ReturnValue, float CallFunc_Multiply_FloatFloat_ReturnValue1, float CallFunc_Multiply_FloatFloat_ReturnValue12, float CallFunc_Multiply_FloatFloat_ReturnValue123, enum class ESubGame CallFunc_GetSubGame_ReturnValue, bool K2Node_SwitchEnum_CmpSuccess, float CallFunc_Multiply_FloatFloat_ReturnValue1234)
{
	static auto Func = Class->GetFunction("B_Pickups_C", "ScaleHologramTimingsForPvP");

	Params::AB_Pickups_C_ScaleHologramTimingsForPvP_Params Parms;
...
void AB_Pickups_C::SetHologramPickedUpParams(bool Tier_0, int32 Temp_int_Array_Index_Variable, int32 Temp_int_Loop_Counter_Variable, int32 CallFunc_Add_IntInt_ReturnValue, int32 Temp_int_Loop_Counter_Variable1, int32 CallFunc_Add_IntInt_ReturnValue1, int32 Temp_int_Array_Index_Variable1, class UMaterialInstanceDynamic* CallFunc_Array_Get_Item, class UMaterialInstanceDynamic* CallFunc_Array_Get_Item1, bool CallFunc_IsValid_ReturnValue, bool CallFunc_IsValid_ReturnValue1, int32 CallFunc_Array_Length_ReturnValue, int32 CallFunc_Array_Length_ReturnValue1, bool CallFunc_Less_IntInt_ReturnValue, bool CallFunc_Less_IntInt_ReturnValue1, float CallFunc_GetGameTimeInSeconds_ReturnValue, float CallFunc_Fraction_ReturnValue, float CallFunc_Multiply_FloatFloat_ReturnValue, float CallFunc_GetGameTimeInSeconds_ReturnValue1, float CallFunc_Fraction_ReturnValue1, float CallFunc_Multiply_FloatFloat_ReturnValue1, float CallFunc_GetGameTimeInSeconds_ReturnValue12, float CallFunc_Add_FloatFloat_ReturnValue, float CallFunc_Add_FloatFloat_ReturnValue1, float CallFunc_GetGameTimeInSeconds_ReturnValue123)
{
	static auto Func = Class->GetFunction("B_Pickups_C", "SetHologramPickedUpParams");

	Params::AB_Pickups_C_SetHologramPickedUpParams_Params Parms;
	Parms.Tier_0 = Tier_0;
	Parms.Temp_int_Array_Index_Variable = Temp_int_Array_Index_Variable;
	Parms.Temp_int_Loop_Counter_Variable = Temp_int_Loop_Counter_Variable;
	Parms.CallFunc_Add_IntInt_ReturnValue = CallFunc_Add_IntInt_ReturnValue;
...
{
	static auto Func = Class->GetFunction("B_Pickups_C", "SpawnPickedUpTrailPS");

	Params::AB_Pickups_C_SpawnPickedUpTrailPS_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_Pickups_C", "SetRarityColor");

	Params::AB_Pickups_C_SetRarityColor_Params Parms;
	Parms.CallFunc_IsValid_ReturnValue = CallFunc_IsValid_ReturnValue;
...
{
	static auto Func = Class->GetFunction("B_Pickups_C", "MobileSelectedTL__FinishedFunc");

	Params::AB_Pickups_C_MobileSelectedTL__FinishedFunc_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_Pickups_C", "MobileSelectedTL__UpdateFunc");

	Params::AB_Pickups_C_MobileSelectedTL__UpdateFunc_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_Pickups_C", "OnLoaded_545E96BB48C612EC956D439BF0008DCB");

	Params::AB_Pickups_C_OnLoaded_545E96BB48C612EC956D439BF0008DCB_Params Parms;
	Parms.Loaded = Loaded;
...
{
	static auto Func = Class->GetFunction("B_Pickups_C", "OnLoaded_8EE257FB4892F606952F3B9974CE26D4");

	Params::AB_Pickups_C_OnLoaded_8EE257FB4892F606952F3B9974CE26D4_Params Parms;
	Parms.Loaded = Loaded;
...
{
	static auto Func = Class->GetFunction("B_Pickups_C", "OnLoaded_E6CB94744AD5E69A7AE15B925703AA9F");

	Params::AB_Pickups_C_OnLoaded_E6CB94744AD5E69A7AE15B925703AA9F_Params Parms;
	Parms.Loaded = Loaded;
...
{
	static auto Func = Class->GetFunction("B_Pickups_C", "OnAboutToEnterBackpack");

	Params::AB_Pickups_C_OnAboutToEnterBackpack_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_Pickups_C", "ReceiveTick");

	Params::AB_Pickups_C_ReceiveTick_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_Pickups_C", "OnTossed");

	Params::AB_Pickups_C_OnTossed_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_Pickups_C", "OnPickedUp");

	Params::AB_Pickups_C_OnPickedUp_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_Pickups_C", "ReceiveDestroyed");

	Params::AB_Pickups_C_ReceiveDestroyed_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_Pickups_C", "ReceiveBeginPlay");

	Params::AB_Pickups_C_ReceiveBeginPlay_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_Pickups_C", "EnableBacchusHighlight");

	Params::AB_Pickups_C_EnableBacchusHighlight_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_Pickups_C", "DisableBacchusHighlight");

	Params::AB_Pickups_C_DisableBacchusHighlight_Params Parms;
...
// enum class ESubGame                CallFunc_GetSubGame_ReturnValue12                                (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// enum class ESubGame                CallFunc_GetSubGame_ReturnValue123                               (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                               K2Node_SwitchEnum123_CmpSuccess                                  (ZeroConstructor, IsPlainOldData, NoDestructor)
// float                              CallFunc_RandomFloatInRange_ReturnValue                          (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UMaterialInterface*          K2Node_Select1234_Default                                        (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void AB_Pickups_C::ExecuteUbergraph_B_Pickups(int32 EntryPoint, class UObject* Temp_object_Variable, class UParticleSystem* K2Node_DynamicCast_AsParticle_System, bool K2Node_DynamicCast_bSuccess, class UObject* K2Node_CustomEvent_Loaded, class UObject* Temp_object_Variable1, class UParticleSystem* K2Node_DynamicCast_AsParticle_System1, bool K2Node_DynamicCast_bSuccess1, const struct FRotator& CallFunc_MakeRotator_ReturnValue, float CallFunc_Multiply_FloatFloat_ReturnValue, bool CallFunc_K2_SetActorRotation_ReturnValue, const struct FRotator& CallFunc_MakeRotator_ReturnValue1, bool Temp_bool_Variable, float Temp_float_Variable, int32 Temp_int_Variable, class UMaterialInterface* Temp_object_Variable12, class UMaterialInterface* Temp_object_Variable123, class UMaterialInterface* Temp_object_Variable1234, class UMaterialInterface* Temp_object_Variable12345, class UMaterialInterface* Temp_object_Variable123456, int32 CallFunc_Array_LastIndex_ReturnValue, class AFortPawn* K2Node_Event_PickupTarget, bool CallFunc_IsLocallyControlled_ReturnValue, class AController* CallFunc_GetController_ReturnValue, bool CallFunc_IsValid_ReturnValue, class AFortPlayerController* K2Node_DynamicCast_AsFort_Player_Controller, bool K2Node_DynamicCast_bSuccess12, bool CallFunc_IsDedicatedServer_ReturnValue, float K2Node_Event_DeltaSeconds, class UFortIngredientItemDefinition* K2Node_DynamicCast_AsFort_Ingredient_Item_Definition, bool K2Node_DynamicCast_bSuccess123, class UFortResourceItemDefinition* K2Node_DynamicCast_AsFort_Resource_Item_Definition, bool K2Node_DynamicCast_bSuccess1234, float Temp_float_Variable1, class UObject* K2Node_CustomEvent_Loaded1, bool CallFunc_BooleanAND_ReturnValue, class UObject* Temp_object_Variable1234567, class UParticleSystem* K2Node_DynamicCast_AsParticle_System12, bool K2Node_DynamicCast_bSuccess12345, enum class ESubGame CallFunc_GetSubGame_ReturnValue, class UParticleSystemComponent* CallFunc_SpawnEmitterAttached_ReturnValue, bool K2Node_SwitchEnum_CmpSuccess, enum class ESubGame CallFunc_GetSubGame_ReturnValue1, const struct FVector& CallFunc_K2_GetComponentLocation_ReturnValue, class UParticleSystemComponent* CallFunc_SpawnEmitterAtLocation_ReturnValue, bool CallFunc_GreaterEqual_IntInt_ReturnValue, class UObject* K2Node_CustomEvent_Loaded12, bool CallFunc_IsValid_ReturnValue1, float Temp_float_Variable12, bool CallFunc_GetPickupRarityMID_bNeedsToBeInitialized, class UMaterialInstanceDynamic* CallFunc_GetPickupRarityMID_ReturnValue, const struct FHitResult& CallFunc_K2_SetRelativeLocation_SweepHitResult, const struct FRotator& CallFunc_SelectRotator_ReturnValue, bool CallFunc_K2_AttachToComponent_ReturnValue, const struct FHitResult& CallFunc_K2_SetRelativeRotation_SweepHitResult, const struct FHitResult& CallFunc_K2_SetRelativeLocation_SweepHitResult1, class AActor* CallFunc_GetOwner_ReturnValue, bool Temp_bool_Variable1, class AFortPickupBackpack* K2Node_DynamicCast_AsFort_Pickup_Backpack, bool K2Node_DynamicCast_bSuccess123456, bool CallFunc_IsDedicatedServer_ReturnValue1, const struct FVector& CallFunc_K2_GetActorLocation_ReturnValue, const struct FVector& CallFunc_K2_GetComponentLocation_ReturnValue1, const struct FVector& CallFunc_GetComponentBounds_Origin, const struct FVector& CallFunc_GetComponentBounds_BoxExtent, float CallFunc_GetComponentBounds_SphereRadius, const struct FVector& CallFunc_Subtract_VectorVector_ReturnValue, int32 CallFunc_GetNumMaterials_ReturnValue, const struct FVector& CallFunc_Add_VectorVector_ReturnValue, const struct FHitResult& CallFunc_K2_SetWorldLocation_SweepHitResult, bool CallFunc_IsValid_ReturnValue12, float Temp_float_Variable123, const struct FHitResult& CallFunc_K2_SetRelativeTransform_SweepHitResult, bool Temp_bool_Variable12, enum class ESubGame CallFunc_GetSubGame_ReturnValue12, bool K2Node_SwitchEnum1_CmpSuccess, bool CallFunc_EqualEqual_IntInt_ReturnValue, float CallFunc_Add_FloatFloat_ReturnValue, int32 Temp_int_Variable1, float CallFunc_Add_FloatFloat_ReturnValue1, class UMaterialInstanceDynamic* CallFunc_Array_Get_Item, float CallFunc_Add_FloatFloat_ReturnValue12, bool CallFunc_LessEqual_IntInt_ReturnValue, int32 CallFunc_Add_IntInt_ReturnValue, enum class ESubGame Temp_byte_Variable, float CallFunc_GetNumericCVar_OutValue, bool CallFunc_GetNumericCVar_ReturnValue, bool CallFunc_GreaterEqual_FloatFloat_ReturnValue, float K2Node_Select_Default, float CallFunc_Divide_FloatFloat_ReturnValue, bool CallFunc_IsMobilePlatform_ReturnValue, float CallFunc_Multiply_FloatFloat_ReturnValue1, float K2Node_Select1_Default, bool CallFunc_IsValid_ReturnValue123, class AGameStateBase* CallFunc_GetGameState_ReturnValue, class AFortGameStateAthena* K2Node_DynamicCast_AsFort_Game_State_Athena, bool K2Node_DynamicCast_bSuccess1234567, float K2Node_Select12_Default, bool CallFunc_IsAssetNull_ReturnValue, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate1, class UParticleSystemComponent* CallFunc_SpawnEmitterAttached_ReturnValue1, bool CallFunc_IsAssetNull_ReturnValue1, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate12, class UParticleSystemComponent* CallFunc_SpawnEmitterAttached_ReturnValue12, bool CallFunc_IsAssetNull_ReturnValue12, bool K2Node_SwitchEnum12_CmpSuccess, const struct FHitResult& CallFunc_K2_SetRelativeRotation_SweepHitResult1, float Temp_float_Variable1234, const struct FVector& CallFunc_Conv_FloatToVector_ReturnValue, float K2Node_Select123_Default, enum class ESubGame CallFunc_GetSubGame_ReturnValue123, bool K2Node_SwitchEnum123_CmpSuccess, float CallFunc_RandomFloatInRange_ReturnValue, class UMaterialInterface* K2Node_Select1234_Default)
{
	static auto Func = Class->GetFunction("B_Pickups_C", "ExecuteUbergraph_B_Pickups");

	Params::AB_Pickups_C_ExecuteUbergraph_B_Pickups_Params Parms;
	...
	Parms.CallFunc_GetSubGame_ReturnValue123 = CallFunc_GetSubGame_ReturnValue123;
