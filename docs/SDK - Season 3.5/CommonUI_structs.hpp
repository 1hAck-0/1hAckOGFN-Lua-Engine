...
public:
	...
	uint8                                        Pad_D00[0x7];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_D02[0x5];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_D03[0x88];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FSlateBrush                           TouchSpecificBrush;                                // 0x198(0x88)(Edit, NativeAccessSpecifierPublic)
};
...
public:
	...
	struct FCommonInputKeyDisplayData            Value;                                             // 0x18(0x220)(Edit, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_D05[0xA8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FCommonInputTypeInfo                  TouchInputTypeInfo;                                // 0x230(0xA8)(Edit, Protected, NativeAccessSpecifierProtected)
};
