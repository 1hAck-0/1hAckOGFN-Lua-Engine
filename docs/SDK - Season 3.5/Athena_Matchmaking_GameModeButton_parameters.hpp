...
public:
	...
	TArray<enum class EFortAthenaPlaylist>       Debug;                                             // 0x10(0x10)(Edit, BlueprintVisible, ZeroConstructor)
	...
	bool                                         CallFunc_IsPlaylistEnabled_ReturnValue;            // 0x28(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_422A[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<class UFortPlaylistAthena*>           CallFunc_GetActivePlaylists_ReturnValue;           // 0x30(0x10)(ZeroConstructor, ReferenceParm)
	int32                                        CallFunc_GetCurrentPartySize_ReturnValue;          // 0x40(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
