...
void UAthenaDirectAcquisitionOfferDetailsWidget_C::SetupSaleInfo(bool bHasSale, class FText SaleText, const class FString& BannerOverrideTag, class FText NormalPrice, bool bHasBattlePassStars, int32 NumOfBattlePassStars, bool Temp_bool_Variable, enum class ESlateVisibility Temp_byte_Variable, enum class ESlateVisibility Temp_byte_Variable1, bool Temp_bool_Variable1, enum class ESlateVisibility K2Node_Select_Default, enum class ESlateVisibility Temp_byte_Variable12, enum class ESlateVisibility Temp_byte_Variable123, enum class ESlateVisibility K2Node_Select1_Default)
{
...
// enum class ESlateSizeRule          Temp_byte_Variable12                                             (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// enum class ESlateSizeRule          Temp_byte_Variable123                                            (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// bool                               Temp_bool_Variable1                                              (ZeroConstructor, IsPlainOldData, NoDestructor)
// enum class ESlateSizeRule          Temp_byte_Variable1234                                           (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// enum class ESlateSizeRule          K2Node_Select1_Default                                           (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// enum class ESlateSizeRule          Temp_byte_Variable12345                                          (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// enum class ESlateSizeRule          K2Node_Select12_Default                                          (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// class UFortDirectAcquisitionOfferInfo*CallFunc_GetOfferInfo_ReturnValue1234567                         (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UAthenaDirectAcquisitionOfferDetailsWidget_C::UpdateFromOffer(const TArray<class FString>& PlaceholderOneRecipient, int32 Temp_int_Array_Index_Variable, class UFortRuntimeOptions* CallFunc_GetRuntimeOptions_ReturnValue, bool CallFunc_IsGiftingDisabledOnCurrentPlatform_ReturnValue, TArray<class FString>& K2Node_MakeArray_Array, class UFortDirectAcquisitionOfferInfo* CallFunc_GetOfferInfo_ReturnValue, const class FString& CallFunc_GetOfferId_ReturnValue, enum class ESlateVisibility Temp_byte_Variable, class UFortDirectAcquisitionOfferInfo* CallFunc_GetOfferInfo_ReturnValue1, bool CallFunc_IsUnique_ReturnValue, class UFortDirectAcquisitionOfferInfo* CallFunc_GetOfferInfo_ReturnValue12, class UFortAccountItem* CallFunc_CreatePreviewItem_ReturnValue, class UVerticalBoxSlot* CallFunc_SlotAsVerticalBoxSlot_ReturnValue, class UHorizontalBoxSlot* CallFunc_SlotAsHorizontalBoxSlot_ReturnValue, class UFortDirectAcquisitionOfferInfo* CallFunc_GetOfferInfo_ReturnValue123, bool CallFunc_IsExclusive_ReturnValue, enum class ESlateVisibility Temp_byte_Variable1, bool Temp_bool_Variable, class UFortDirectAcquisitionOfferInfo* CallFunc_GetOfferInfo_ReturnValue1234, enum class ESlateVisibility K2Node_Select_Default, class UFortAccountItemDefinition* CallFunc_GetFirstGrantItemDefinition_ReturnValue, class UAthenaGliderItemDefinition* K2Node_DynamicCast_AsAthena_Glider_Item_Definition, bool K2Node_DynamicCast_bSuccess, class FName CallFunc_MakeLiteralName_ReturnValue, class UMaterialInstanceDynamic* CallFunc_GetDynamicMaterial_ReturnValue, class FName CallFunc_MakeLiteralName_ReturnValue1, enum class ESlateSizeRule Temp_byte_Variable12, class UMaterialInstanceDynamic* CallFunc_GetDynamicMaterial_ReturnValue1, enum class ESlateSizeRule Temp_byte_Variable123, class UMaterialInstanceDynamic* CallFunc_GetDynamicFontMaterial_ReturnValue, bool Temp_bool_Variable1, enum class ESlateSizeRule Temp_byte_Variable1234, enum class ESlateSizeRule K2Node_Select1_Default, enum class ESlateSizeRule Temp_byte_Variable12345, const struct FSlateChildSize& K2Node_MakeStruct_SlateChildSize, bool Temp_bool_Variable12, enum class ESlateVisibility Temp_byte_Variable123456, enum class ESlateSizeRule K2Node_Select12_Default, enum class ESlateVisibility Temp_byte_Variable1234567, const struct FSlateChildSize& K2Node_MakeStruct_SlateChildSize1, bool Temp_bool_Variable123, enum class ESlateVisibility Temp_byte_Variable12345678, enum class ESlateVisibility K2Node_Select123_Default, enum class ESlateVisibility Temp_byte_Variable123456789, bool Temp_bool_Variable1234, float Temp_float_Variable, enum class ESlateVisibility K2Node_Select1234_Default, float Temp_float_Variable1, class UFortDirectAcquisitionOfferInfo* CallFunc_GetOfferInfo_ReturnValue12345, class FText CallFunc_GetShortDescription_ReturnValue, class FText CallFunc_GetDescription_ReturnValue, class FText CallFunc_GetName_ReturnValue, int32 Temp_int_Loop_Counter_Variable, class FText CallFunc_TextToUpper_ReturnValue, int32 CallFunc_Add_IntInt_ReturnValue, bool Temp_bool_Variable12345, class UFortDirectAcquisitionOfferInfo* CallFunc_GetOfferInfo_ReturnValue123456, int32 CallFunc_GetFirstGrantQuantity_ReturnValue, float K2Node_Select12345_Default, class UFortAccountItemDefinition* CallFunc_GetFirstGrantItemDefinition_ReturnValue1, class UFortItem* CallFunc_CreateTemporaryItemInstanceBP_ReturnValue, enum class EFortRarity CallFunc_GetRarity_ReturnValue, const struct FFortRarityItemData& CallFunc_BPGetRarityData_ReturnValue, class UFortDirectAcquisitionOfferInfo* CallFunc_GetOfferInfo_ReturnValue1234567, bool CallFunc_HasDisplayAsset_ReturnValue, TArray<struct FFortMtxDetailsAttribute>& CallFunc_GetDetailsAttributes_ReturnValue, const struct FFortMtxDetailsAttribute& CallFunc_Array_Get_Item, int32 CallFunc_Array_Length_ReturnValue, bool CallFunc_Less_IntInt_ReturnValue, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue, class UStoreMain_OfferDetailsAttribute_C* CallFunc_Create_ReturnValue, class UFortMcpContext* CallFunc_GetContext_ReturnValue, enum class EOfferPurchaseError CallFunc_CanGiftOffer_ReturnValue, bool K2Node_SwitchEnum_CmpSuccess, class UVerticalBoxSlot* CallFunc_AddChildToVerticalBox_ReturnValue)
{
	...
	Parms.CallFunc_GetOfferInfo_ReturnValue1234567 = CallFunc_GetOfferInfo_ReturnValue1234567;
...
// enum class ESubGame                Temp_byte_Variable1234                                           (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// class UFortDirectAcquisitionOfferInfo*CallFunc_GetOfferInfo_ReturnValue12345                           (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// struct FCatalogOffer               CallFunc_GetOffer_ReturnValue12                                  (ConstParm)
// UDelegateProperty_                 K2Node_CreateDelegate_OutputDelegate12                           (ZeroConstructor, NoDestructor)
// enum class EFrontEndCamera         Temp_byte_Variable123456                                         (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// class UHorizontalBoxSlot*          CallFunc_SlotAsHorizontalBoxSlot_ReturnValue                     (ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// enum class EFrontEndCamera         Temp_byte_Variable1234567                                        (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// bool                               Temp_bool_Variable12                                             (ZeroConstructor, IsPlainOldData, NoDestructor)
// enum class EFrontEndCamera         K2Node_Select123_Default                                         (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UAthenaDirectAcquisitionOfferDetailsWidget_C::ExecuteUbergraph_AthenaDirectAcquisitionOfferDetailsWidget(int32 EntryPoint, class UFortFrontEndContext* CallFunc_GetContext_ReturnValue, class UFortFrontEndContext* CallFunc_GetContext_ReturnValue1, bool Temp_bool_Variable, enum class ESlateVisibility Temp_byte_Variable, enum class ESlateVisibility Temp_byte_Variable1, bool Temp_bool_Variable1, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, enum class ESlateVisibility Temp_byte_Variable12, enum class ESlateVisibility Temp_byte_Variable123, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue12, enum class ESubGame Temp_byte_Variable1234, enum class ESubGame CallFunc_GetSubGame_ReturnValue, float Temp_float_Variable, float Temp_float_Variable1, float Temp_float_Variable12, float Temp_float_Variable123, float K2Node_Select_Default, const struct FMargin& K2Node_MakeStruct_Margin, class UFortDirectAcquisitionOfferInfo* CallFunc_GetOfferInfo_ReturnValue, class UCommonButton* K2Node_ComponentBoundEvent_Button123456, const struct FCatalogOffer& CallFunc_GetOffer_ReturnValue, bool CallFunc_IsUnique_ReturnValue, const struct FDataTableRowHandle& K2Node_MakeStruct_DataTableRowHandle, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate1, class UFortUINavigationManager* CallFunc_GetUINavigationManager_ReturnValue, class UCommonButton* K2Node_ComponentBoundEvent_Button12345, class UCommonButton* K2Node_ComponentBoundEvent_Button1234, int32 CallFunc_Add_IntInt_ReturnValue, int32 CallFunc_Subtract_IntInt_ReturnValue, const struct FFormatArgumentData& K2Node_MakeStruct_FormatArgumentData, class UFortDirectAcquisitionOfferInfo* CallFunc_GetOfferInfo_ReturnValue1, TArray<struct FFormatArgumentData>& K2Node_MakeArray_Array, class UFortAccountItemDefinition* CallFunc_GetCurrencyItemDefinition_ReturnValue, class FText CallFunc_Format_ReturnValue, class UFortItemIcon* CallFunc_SpawnObject_ReturnValue, enum class EFortDialogResult Temp_byte_Variable12345, class UFortAsyncAction_ShowConfirmation_NUI* CallFunc_ShowSimpleConfirmationDialog_CustomInput_ReturnValue, class FName Temp_name_Variable, bool CallFunc_IsValid_ReturnValue, bool CallFunc_BooleanAND_ReturnValue, bool CallFunc_BooleanAND_ReturnValue1, class UCommonButton* K2Node_ComponentBoundEvent_Button123, class UFortDirectAcquisitionOfferInfo* CallFunc_GetOfferInfo_ReturnValue12, int32 CallFunc_Array_Length_ReturnValue, int32 CallFunc_Array_Find_ReturnValue, int32 CallFunc_Add_IntInt_ReturnValue1, class UFortDirectAcquisitionOfferInfo* CallFunc_GetOfferInfo_ReturnValue123, int32 CallFunc_Percent_IntInt_ReturnValue, const struct FCatalogOffer& CallFunc_GetOffer_ReturnValue1, class UFortDirectAcquisitionOfferInfo* CallFunc_Array_Get_Item, class UCommonButton* K2Node_ComponentBoundEvent_Button12, class UFortDirectAcquisitionOfferInfo* CallFunc_GetOfferInfo_ReturnValue1234, int32 CallFunc_Array_LastIndex_ReturnValue, int32 CallFunc_Array_Find_ReturnValue1, class UFortDirectAcquisitionOfferInfo* CallFunc_Array_Get_Item1, int32 CallFunc_Subtract_IntInt_ReturnValue1, class UFortDirectAcquisitionOfferInfo* CallFunc_Array_Get_Item12, bool CallFunc_GreaterEqual_IntInt_ReturnValue, enum class EFortDialogResult K2Node_CustomEvent_Result, class FName K2Node_CustomEvent_ResultName, class UFortDirectAcquisitionOfferInfo* CallFunc_GetOfferInfo_ReturnValue12345, const struct FCatalogOffer& CallFunc_GetOffer_ReturnValue12, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate12, enum class EFrontEndCamera Temp_byte_Variable123456, int32 CallFunc_Array_Length_ReturnValue1, class UCommonButton* K2Node_ComponentBoundEvent_Button1, bool CallFunc_GreaterEqual_IntInt_ReturnValue1, enum class ESlateVisibility K2Node_Select1_Default, class UFortDirectAcquisitionOfferInfo* CallFunc_GetOfferInfo_ReturnValue123456, bool CallFunc_IsUnique_ReturnValue1, class UCommonButton* K2Node_CustomEvent_Button, class UFortDirectAcquisitionOfferInfo* CallFunc_GetOfferInfo_ReturnValue1234567, bool CallFunc_HandleBack_PassThrough, class UCommonButton* K2Node_ComponentBoundEvent_Button, bool CallFunc_HandleBack_PassThrough1, bool CallFunc_IsBROnly_ReturnValue, class UFortFrontEndContext* CallFunc_GetContext_ReturnValue123, enum class ESlateVisibility K2Node_Select12_Default, class UHorizontalBoxSlot* CallFunc_SlotAsHorizontalBoxSlot_ReturnValue, enum class EFrontEndCamera Temp_byte_Variable1234567, bool CallFunc_IsBROnly_ReturnValue1, class UHorizontalBoxSlot* CallFunc_SlotAsHorizontalBoxSlot_ReturnValue1, bool Temp_bool_Variable12, enum class EFrontEndCamera K2Node_Select123_Default)
{
	...
	Parms.CallFunc_GetOfferInfo_ReturnValue12345 = CallFunc_GetOfferInfo_ReturnValue12345;
	Parms.CallFunc_GetOffer_ReturnValue12 = CallFunc_GetOffer_ReturnValue12;
