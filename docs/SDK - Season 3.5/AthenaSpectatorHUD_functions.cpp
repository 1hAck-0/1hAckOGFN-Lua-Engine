...
// enum class ESpectatorCameraType    Temp_byte_Variable12                                             (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// enum class ESpectatorCameraType    Temp_byte_Variable123                                            (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// enum class ECommonInputType        Temp_byte_Variable1234567891011121314                            (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UAthenaSpectatorHUD_C::ShowCameraControls(enum class ESpectatorCameraType CameraType, int32 Temp_int_Variable, int32 Temp_int_Variable1, int32 Temp_int_Variable12, int32 Temp_int_Variable123, class UCommonInputContext* CallFunc_GetContext_ReturnValue, bool Temp_bool_Variable, enum class ECommonInputType CallFunc_GetCurrentInputType_ReturnValue, enum class ESlateVisibility Temp_byte_Variable, enum class ESlateVisibility Temp_byte_Variable1, enum class ESpectatorCameraType Temp_byte_Variable12, int32 Temp_int_Variable1234, int32 Temp_int_Variable12345, int32 Temp_int_Variable123456, int32 Temp_int_Variable1234567, int32 Temp_int_Variable12345678, int32 Temp_int_Variable123456789, int32 Temp_int_Variable12345678910, int32 Temp_int_Variable1234567891011, int32 Temp_int_Variable123456789101112, int32 Temp_int_Variable12345678910111213, enum class ESpectatorCameraType Temp_byte_Variable123, enum class ESlateVisibility Temp_byte_Variable1234, enum class ESlateVisibility Temp_byte_Variable12345, enum class ESlateVisibility Temp_byte_Variable123456, enum class ESlateVisibility Temp_byte_Variable1234567, enum class ESlateVisibility Temp_byte_Variable12345678, enum class ESlateVisibility Temp_byte_Variable123456789, enum class ESlateVisibility Temp_byte_Variable12345678910, enum class ESlateVisibility Temp_byte_Variable1234567891011, enum class ESlateVisibility Temp_byte_Variable123456789101112, enum class ESlateVisibility Temp_byte_Variable12345678910111213, enum class ECommonInputType Temp_byte_Variable1234567891011121314, class APlayerController* CallFunc_GetPlayerController_ReturnValue, class AFortPlayerControllerSpectating* K2Node_DynamicCast_AsFort_Player_Controller_Spectating, bool K2Node_DynamicCast_bSuccess, int32 K2Node_Select_Default, enum class ESlateVisibility K2Node_Select1_Default, bool CallFunc_EqualEqual_ByteByte_ReturnValue, int32 K2Node_Select12_Default, enum class ESlateVisibility K2Node_Select123_Default, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, const struct FTimerHandle& CallFunc_K2_SetTimerDelegate_ReturnValue)
{
...
void UAthenaSpectatorHUD_C::SetViewSettingsVisibility(bool Visible, class UCommonUIContext* CallFunc_GetContext_ReturnValue, class UCommonInputManager* CallFunc_GetInputManager_ReturnValue)
{
	static auto Func = Class->GetFunction("AthenaSpectatorHUD_C", "SetViewSettingsVisibility");

	Params::UAthenaSpectatorHUD_C_SetViewSettingsVisibility_Params Parms;
...
void UAthenaSpectatorHUD_C::Bind_Replay_UI_Events(class APlayerController* CallFunc_GetPlayerController_ReturnValue, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, class AFortReplaySpectator* K2Node_DynamicCast_AsFort_Replay_Spectator, bool K2Node_DynamicCast_bSuccess, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate1, class UFortReplayContext* CallFunc_GetContext_ReturnValue, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate12, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate123, class UCommonUIContext* CallFunc_GetContext_ReturnValue1, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate1234, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate12345, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate123456)
{
...
void UAthenaSpectatorHUD_C::HudVisibilityChangedFromNative(enum class EHudVisibilityState NewVisibilty, enum class ESlateVisibility ReplayHUDVisibility, bool K2Node_SwitchEnum_CmpSuccess, class UFortReplayContext* CallFunc_GetContext_ReturnValue, class FText CallFunc_GetVisibilityText_Text, class UCommonUIContext* CallFunc_GetContext_ReturnValue1, class UCommonInputManager* CallFunc_GetInputManager_ReturnValue, bool CallFunc_IsPanelOnStack_ReturnValue)
{
...
// class UFortReplayContext*          CallFunc_GetContext_ReturnValue123456                            (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UFortReplayContext*          CallFunc_GetContext_ReturnValue1234567                           (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// class UAthenaHUDContext*           CallFunc_GetContext_ReturnValue1234567891011                     (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// class UFortHUDContext*             CallFunc_GetContext_ReturnValue1234567891011121314               (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// class UFortPickerContext*          CallFunc_GetContext_ReturnValue123456789101112131415             (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UAthenaSpectatorHUD_C::ExecuteUbergraph_AthenaSpectatorHUD(int32 EntryPoint, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate1, class UFortHUDContext* CallFunc_GetContext_ReturnValue1, class UFortHUDContext* CallFunc_GetContext_ReturnValue12, class UFortReplayContext* CallFunc_GetContext_ReturnValue123, class UCommonUIContext* CallFunc_GetContext_ReturnValue1234, class UCommonInputManager* CallFunc_GetInputManager_ReturnValue, class UCommonUIContext* CallFunc_GetContext_ReturnValue12345, enum class EHudVisibilityState Temp_byte_Variable, class UCommonInputManager* CallFunc_GetInputManager_ReturnValue1, class USoundBase* Temp_object_Variable, class USoundBase* Temp_object_Variable1, class USoundBase* Temp_object_Variable12, class USoundBase* Temp_object_Variable123, class UFortReplayContext* CallFunc_GetContext_ReturnValue123456, class UFortReplayContext* CallFunc_GetContext_ReturnValue1234567, class UFortHUDContext* CallFunc_GetContext_ReturnValue12345678, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate12, enum class EFortUIState K2Node_Event_PreviousUIState, class UFortHUDContext* CallFunc_GetContext_ReturnValue123456789, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate123, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate1234, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate12345, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate123456, class UFortHUDContext* CallFunc_GetContext_ReturnValue12345678910, class UAthenaHUDContext* CallFunc_GetContext_ReturnValue1234567891011, int32 Temp_int_Array_Index_Variable, TArray<class UFortQuestItem*>& K2Node_CustomEvent_Quests, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue123456789101112, class UFortQuestItem* CallFunc_Array_Get_Item, const struct FSlateBrush& CallFunc_GetItemSmallPreviewImageBrush_ReturnValue, class FText CallFunc_GetDisplayName_ReturnValue, const struct FFormatArgumentData& K2Node_MakeStruct_FormatArgumentData, int32 CallFunc_Array_Length_ReturnValue, TArray<struct FFormatArgumentData>& K2Node_MakeArray_Array, class UFortHUDContext* CallFunc_GetContext_ReturnValue12345678910111213, class FText CallFunc_Format_ReturnValue, const struct FFortDialogDescription& K2Node_MakeStruct_FortDialogDescription, class UFortAsyncAction_TriggerNotification* CallFunc_TriggerNotification_ReturnValue, bool CallFunc_IsValid_ReturnValue, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate1234567, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate12345678, const struct FGameplayTagContainer& K2Node_CustomEvent_FailedReason, class FText K2Node_CustomEvent_FailureText, bool CallFunc_HasTag_ReturnValue, class UFortHUDContext* CallFunc_GetContext_ReturnValue1234567891011121314, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate123456789, const struct FFortPlayerDeathReport& K2Node_CustomEvent_DeathReport, class UFortPickerContext* CallFunc_GetContext_ReturnValue123456789101112131415, class UWidget* K2Node_Event_Widget, const struct FContentPushState& K2Node_Event_State, class UAthenaPlayerViewModel* K2Node_Event_ViewModel, bool K2Node_Event_bIsVisible, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate12345678910, class UCommonButton* K2Node_ComponentBoundEvent_Button, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate1234567891011, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate123456789101112, enum class EHudVisibilityState K2Node_CustomEvent_HUDVisibility, int32 Temp_int_Loop_Counter_Variable, class USoundBase* K2Node_Select_Default, bool CallFunc_Less_IntInt_ReturnValue, int32 CallFunc_Add_IntInt_ReturnValue, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue12345678910111213141516, class UFortQuestManager* CallFunc_GetQuestManager_ReturnValue)
{
