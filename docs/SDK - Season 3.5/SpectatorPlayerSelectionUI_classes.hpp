...
public:
	...
	class UScrollBox*                            ScrollBox_151;                                     // 0x218(0x8)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	struct FButtonStyle                          ButtonStyle;                                       // 0x220(0x278)(Edit, BlueprintVisible, DisableEditOnInstance)
	TMap<class UButton*, class AFortPlayerState*> ButtonToPlayerStateMap;                            // 0x498(0x50)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	struct FButtonStyle                          FollowedButtonStyle;                               // 0x4E8(0x278)(Edit, BlueprintVisible, DisableEditOnInstance)
	TMap<class AFortPlayerState*, class UButton*> PlayerStateToButtonMap;                            // 0x760(0x50)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance)
	class UButton*                               FollowedPlayerButton;                              // 0x7B0(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
