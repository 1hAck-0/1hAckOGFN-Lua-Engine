...
public:
	...
	uint8                                        Pad_4332[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	class FString                                CallFunc_Concat_StrStr_ReturnValue12;              // 0x108(0x10)(ZeroConstructor, HasGetValueTypeHash)
	class FText                                  CallFunc_Conv_IntToText_ReturnValue12;             // 0x118(0x18)()
	class FText                                  CallFunc_Conv_StringToText_ReturnValue12;          // 0x130(0x18)()
	class FText                                  CallFunc_GetDateTimeText_ReturnValue;              // 0x148(0x18)()
	class FText                                  CallFunc_Conv_StringToText_ReturnValue123;         // 0x160(0x18)()
};
