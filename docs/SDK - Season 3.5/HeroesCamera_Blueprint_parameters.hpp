...
public:
	...
	uint8                                        Pad_4CC9[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FKey                                  K2Node_InputKeyEvent_Key12;                        // 0x8(0x18)(HasGetValueTypeHash)
	...
	struct FKey                                  K2Node_InputKeyEvent_Key123;                       // 0x88(0x18)(HasGetValueTypeHash)
	...
	class APlayerController*                     CallFunc_GetPlayerController_ReturnValue12;        // 0xF8(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
