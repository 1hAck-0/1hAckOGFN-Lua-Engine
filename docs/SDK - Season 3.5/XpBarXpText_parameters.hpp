...
public:
	...
	struct FFortItemQuantityPair                 CallFunc_Array_Get_Item;                           // 0x68(0x30)()
};
...
public:
	...
	struct FFormatArgumentData                   K2Node_MakeStruct_FormatArgumentData12;            // 0x108(0x40)(HasGetValueTypeHash)
