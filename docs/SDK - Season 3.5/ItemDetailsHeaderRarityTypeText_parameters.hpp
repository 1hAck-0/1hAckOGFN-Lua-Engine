...
public:
	...
	enum class EFortRarity                       CallFunc_GetRarity_ReturnValue;                    // 0x5(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_343E[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FSlateColor                           K2Node_MakeStruct_SlateColor1;                     // 0x130(0x28)()
	struct FSlateColor                           K2Node_MakeStruct_SlateColor12;                    // 0x158(0x28)()
