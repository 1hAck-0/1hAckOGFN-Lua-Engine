...
public:
	...
	struct FFortItemTransformFilterTabLabelInfo  CallFunc_Array_Get_Item;                           // 0x20(0xC0)()
	...
	bool                                         CallFunc_EqualEqual_NameName_ReturnValue;          // 0xE2(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
