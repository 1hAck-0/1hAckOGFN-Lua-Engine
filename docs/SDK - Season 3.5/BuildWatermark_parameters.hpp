...
public:
	...
	uint8                                        Pad_48AA[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	class FString                                CallFunc_GetAppName_ReturnValue;                   // 0x48(0x10)(ZeroConstructor, HasGetValueTypeHash)
	...
	class FText                                  CallFunc_Conv_StringToText_ReturnValue1;           // 0x60(0x18)()
	class FText                                  CallFunc_GetPlayAgainstWatermarkText_ReturnValue;  // 0x78(0x18)()
	class FText                                  CallFunc_GetFillWithWatermarkText_ReturnValue;     // 0x90(0x18)()
	class UFortFrontEndContext*                  CallFunc_GetContext_ReturnValue123;                // 0xA8(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class FText                                  CallFunc_GetMCPRegion_ReturnValue;                 // 0xB0(0x18)()
};
