...
public:
	...
	int32                                        CallFunc_Array_Add_ReturnValue12;                  // 0x208(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
{
public:
	struct FFortDialogDescription_NUI            NewDescription;                                    // 0x0(0x180)(BlueprintVisible, BlueprintReadOnly, Parm, ContainsInstancedReference)
};
