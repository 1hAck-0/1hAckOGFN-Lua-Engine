...
public:
	...
	uint8                                        Pad_4AB2[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	enum class ESkillTreePages                   Temp_byte_Variable12;                              // 0xFC(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_4AB3[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FLinearColor                          K2Node_Select12_Default;                           // 0x100(0x10)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
