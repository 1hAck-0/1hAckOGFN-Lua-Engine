...
void UAthenaHUD_C::HasClientBeenNotifiedOfWin(bool* bClientWon, bool* bTeamWon, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue, class AFortPlayerControllerAthena* K2Node_DynamicCast_AsFort_Player_Controller_Athena, bool K2Node_DynamicCast_bSuccess, bool CallFunc_IsClientNotifiedOfWin_ReturnValue, bool CallFunc_IsClientNotifiedOfTeamWin_ReturnValue)
{
	static auto Func = Class->GetFunction("AthenaHUD_C", "HasClientBeenNotifiedOfWin");

	Params::UAthenaHUD_C_HasClientBeenNotifiedOfWin_Params Parms;
...
// bool                               CallFunc_HasClientBeenNotifiedOfWin_bClientWon                   (ZeroConstructor, IsPlainOldData, NoDestructor)
// bool                               CallFunc_HasClientBeenNotifiedOfWin_bTeamWon                     (ZeroConstructor, IsPlainOldData, NoDestructor)
// bool                               Temp_bool_Variable1                                              (ZeroConstructor, IsPlainOldData, NoDestructor)
...
void UAthenaHUD_C::HandleCursorModeChanged(bool IsEnabled, class FName ActionName, class UUserWidget* CursorModeContentCustomWidget, enum class ESlateVisibility Temp_byte_Variable, enum class ESlateVisibility Temp_byte_Variable1, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue, bool Temp_bool_Variable, enum class EFortInputMode Temp_byte_Variable12, enum class EFortInputMode Temp_byte_Variable123, bool CallFunc_HasClientBeenNotifiedOfWin_bClientWon, bool CallFunc_HasClientBeenNotifiedOfWin_bTeamWon, bool Temp_bool_Variable1, enum class EFortInputMode K2Node_Select_Default, class UCommonUIContext* CallFunc_GetContext_ReturnValue1, class UCommonInputManager* CallFunc_GetInputManager_ReturnValue, class UFortHUDContext* CallFunc_GetContext_ReturnValue12, bool CallFunc_BooleanOR_ReturnValue, bool CallFunc_BooleanOR_ReturnValue1, enum class ESlateVisibility K2Node_Select1_Default)
{
	...
	Parms.Temp_byte_Variable12 = Temp_byte_Variable12;
	Parms.Temp_byte_Variable123 = Temp_byte_Variable123;
	Parms.CallFunc_HasClientBeenNotifiedOfWin_bClientWon = CallFunc_HasClientBeenNotifiedOfWin_bClientWon;
	Parms.CallFunc_HasClientBeenNotifiedOfWin_bTeamWon = CallFunc_HasClientBeenNotifiedOfWin_bTeamWon;
	Parms.Temp_bool_Variable1 = Temp_bool_Variable1;
	Parms.K2Node_Select_Default = K2Node_Select_Default;
	Parms.CallFunc_GetContext_ReturnValue1 = CallFunc_GetContext_ReturnValue1;
	Parms.CallFunc_GetInputManager_ReturnValue = CallFunc_GetInputManager_ReturnValue;
