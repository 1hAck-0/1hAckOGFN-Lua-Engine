...
void UAthenaStatsTab_C::CanShowStats(bool* bCanShowStats, bool CallFunc_IsBROnly_ReturnValue, class UFortLeaderboardContext* CallFunc_GetContext_ReturnValue, bool CallFunc_CanShowStats_ReturnValue)
{
