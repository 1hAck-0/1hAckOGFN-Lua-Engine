...
public:
	...
	class UFortPartyContext*                     CallFunc_GetContext_ReturnValue12;                 // 0x168(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FFormatArgumentData                   K2Node_MakeStruct_FormatArgumentData12;            // 0x398(0x40)(HasGetValueTypeHash)
	class UFortPartyContext*                     CallFunc_GetContext_ReturnValue123;                // 0x3D8(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FFortTeamMemberInfo                   CallFunc_GetLocalPlayerTeamMemberInfo_LocalPlayerInfo1; // 0x3E0(0x1F8)(HasGetValueTypeHash)
	struct FFormatArgumentData                   K2Node_MakeStruct_FormatArgumentData123;           // 0x5D8(0x40)(HasGetValueTypeHash)
