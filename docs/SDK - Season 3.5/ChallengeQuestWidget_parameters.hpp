...
public:
	...
	enum class EQuestVisualStyle                 Temp_byte_Variable1234;                            // 0x10(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	TArray<struct FFortItemQuantityPair>         CallFunc_GetRewards_BP_ReturnValue;                // 0x18(0x10)(ZeroConstructor, ReferenceParm)
	struct FFortRewardInfo                       CallFunc_GetRewardInfo_BP_ReturnValue;             // 0x28(0x30)()
	struct FFortItemQuantityPair                 CallFunc_Array_Get_Item;                           // 0x58(0x30)()
	enum class ESlateVisibility                  Temp_byte_Variable1;                               // 0x88(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_EqualEqual_SoftObjectReference_ReturnValue; // 0x89(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
