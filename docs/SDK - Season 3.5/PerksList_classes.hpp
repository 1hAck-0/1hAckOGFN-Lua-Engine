...
public:
	...
	uint8                                        Pad_3ED3[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FMargin                               RowPadding;                                        // 0x32C(0x10)(Edit, BlueprintVisible, IsPlainOldData, NoDestructor)
	struct FMargin                               Description_Padding;                               // 0x33C(0x10)(Edit, BlueprintVisible, IsPlainOldData, NoDestructor)
