...
public:
	...
	uint8                                        Pad_45DC[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
struct UAthenaAerialFeedback_C_CustomEvent_1_Params
{
public:
};
...
struct UAthenaAerialFeedback_C_CustomEvent_2_Params
{
public:
...
public:
	...
	enum class EAthenaGamePhaseStep              K2Node_CustomEvent_GamePhaseStep;                  // 0x4(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_SwitchEnum_CmpSuccess;                      // 0x5(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_45DD[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	class UAthenaHUDContext*                     CallFunc_GetContext_ReturnValue;                   // 0x68(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
