...
void UAthenaReplayBrowserRenameDialog_C::OnConfirmRename__DelegateSignature(class UAthenaReplayBrowserRowProxyInstance* BrowserRowProxy, class FText NewName)
{
