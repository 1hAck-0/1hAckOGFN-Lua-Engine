...
public:
	...
	UMulticastDelegateProperty_                  WidgetVisibilityChanged;                           // 0x2C8(0x10)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
