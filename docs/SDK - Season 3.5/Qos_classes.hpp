...
{
public:
	uint8                                        Pad_F77[0x68];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_F78[0x10];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_F79[0xA8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_F7A[0x2];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<struct FQosRegionInfo>                Datacenters;                                       // 0xE0(0x10)(ZeroConstructor, Transient, NativeAccessSpecifierPrivate)
	uint8                                        Pad_F7B[0x30];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_F80[0x10];                                     // Fixing Size Of Struct [ Dumper-7 ]
