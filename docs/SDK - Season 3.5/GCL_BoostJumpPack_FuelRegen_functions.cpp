...
float AGCL_BoostJumpPack_FuelRegen_C::GetFuel(bool Temp_bool_Variable, bool CallFunc_IsValid_ReturnValue, float CallFunc_GetSimulatedJetpackFuel_ReturnValue, bool CallFunc_GetFloatAttribute_bSuccessfullyFoundAttribute, float CallFunc_GetFloatAttribute_ReturnValue, float K2Node_Select_Default)
{
