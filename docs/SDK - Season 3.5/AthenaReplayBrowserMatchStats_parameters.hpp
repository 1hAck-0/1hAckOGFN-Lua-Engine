...
public:
	...
	class FText                                  CallFunc_Conv_IntToText_ReturnValue12;             // 0x50(0x18)()
	class FText                                  CallFunc_Conv_IntToText_ReturnValue123;            // 0x68(0x18)()
	...
	class FText                                  CallFunc_Conv_IntToText_ReturnValue1234;           // 0xA0(0x18)()
	class FText                                  CallFunc_Conv_StringToText_ReturnValue;            // 0xB8(0x18)()
	class FText                                  CallFunc_Conv_IntToText_ReturnValue12345;          // 0xD0(0x18)()
	class FText                                  CallFunc_Conv_IntToText_ReturnValue123456;         // 0xE8(0x18)()
	class FText                                  CallFunc_Conv_IntToText_ReturnValue1234567;        // 0x100(0x18)()
	class FText                                  CallFunc_Conv_IntToText_ReturnValue12345678;       // 0x118(0x18)()
	class FText                                  CallFunc_Conv_IntToText_ReturnValue123456789;      // 0x130(0x18)()
	class FString                                CallFunc_Conv_IntToString_ReturnValue1;            // 0x148(0x10)(ZeroConstructor, HasGetValueTypeHash)
	class FString                                CallFunc_Concat_StrStr_ReturnValue12;              // 0x158(0x10)(ZeroConstructor, HasGetValueTypeHash)
	class FText                                  CallFunc_Conv_IntToText_ReturnValue12345678910;    // 0x168(0x18)()
	class FText                                  CallFunc_Conv_StringToText_ReturnValue1;           // 0x180(0x18)()
	class FText                                  CallFunc_Conv_IntToText_ReturnValue1234567891011;  // 0x198(0x18)()
	class FString                                CallFunc_Conv_IntToString_ReturnValue12;           // 0x1B0(0x10)(ZeroConstructor, HasGetValueTypeHash)
	class FString                                CallFunc_Concat_StrStr_ReturnValue123;             // 0x1C0(0x10)(ZeroConstructor, HasGetValueTypeHash)
	class FText                                  CallFunc_Conv_StringToText_ReturnValue12;          // 0x1D0(0x18)()
};
