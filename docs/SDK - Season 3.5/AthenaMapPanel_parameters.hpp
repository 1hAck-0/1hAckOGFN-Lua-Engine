...
public:
	...
	enum class ECommonGamepadType                Temp_byte_Variable;                                // 0x90(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_3F84[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FSlateBrush                           Temp_struct_Variable1;                             // 0x98(0x88)()
	class UCommonInputContext*                   CallFunc_GetContext_ReturnValue;                   // 0x120(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	enum class ECommonGamepadType                CallFunc_GetCurrentGamepadType_ReturnValue;        // 0x128(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	enum class ECommonGamepadType                Temp_byte_Variable1;                               // 0x129(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_3F85[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FSlateBrush                           K2Node_MakeStruct_SlateBrush;                      // 0x130(0x88)()
	struct FSlateBrush                           K2Node_MakeStruct_SlateBrush1;                     // 0x1B8(0x88)()
	struct FSlateBrush                           K2Node_MakeStruct_SlateBrush12;                    // 0x240(0x88)()
	struct FSlateBrush                           K2Node_Select_Default;                             // 0x2C8(0x88)()
	struct FSlateBrush                           K2Node_MakeStruct_SlateBrush123;                   // 0x350(0x88)()
	struct FSlateBrush                           K2Node_Select1_Default;                            // 0x3D8(0x88)()
};
