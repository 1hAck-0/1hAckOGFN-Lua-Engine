...
public:
	...
	enum class ESlateVisibility                  Temp_byte_Variable12;                              // 0x41(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                         Temp_bool_Variable123;                             // 0x43(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	bool                                         Temp_bool_Variable1234;                            // 0x4C(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	bool                                         Temp_bool_Variable12345;                           // 0xA8(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_42D3[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class FText                                  CallFunc_Format_ReturnValue;                       // 0xB0(0x18)()
	class FText                                  K2Node_Select12_Default;                           // 0xC8(0x18)()
	class FText                                  K2Node_Select123_Default;                          // 0xE0(0x18)()
	...
	class FText                                  K2Node_Select1234_Default;                         // 0x168(0x18)()
	...
	float                                        K2Node_Select12345_Default;                        // 0x188(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
