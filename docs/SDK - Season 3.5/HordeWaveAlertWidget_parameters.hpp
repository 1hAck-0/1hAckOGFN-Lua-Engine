...
public:
	...
	struct FFormatArgumentData                   K2Node_MakeStruct_FormatArgumentData12;            // 0x1A0(0x40)(HasGetValueTypeHash)
	TArray<struct FFortItemInstanceQuantityPair> K2Node_CustomEvent_Items;                          // 0x1E0(0x10)(ConstParm, ZeroConstructor, ReferenceParm)
	TArray<struct FFormatArgumentData>           K2Node_MakeArray_Array12;                          // 0x1F0(0x10)(ZeroConstructor, ReferenceParm)
	class FText                                  CallFunc_Format_ReturnValue12;                     // 0x200(0x18)()
	UDelegateProperty_                           K2Node_CreateDelegate_OutputDelegate1234;          // 0x218(0x10)(ZeroConstructor, NoDestructor)
	UDelegateProperty_                           K2Node_CreateDelegate_OutputDelegate12345;         // 0x228(0x10)(ZeroConstructor, NoDestructor)
	...
	UDelegateProperty_                           K2Node_CreateDelegate_OutputDelegate1234567;       // 0x258(0x10)(ZeroConstructor, NoDestructor)
	UDelegateProperty_                           K2Node_CreateDelegate_OutputDelegate12345678;      // 0x268(0x10)(ZeroConstructor, NoDestructor)
