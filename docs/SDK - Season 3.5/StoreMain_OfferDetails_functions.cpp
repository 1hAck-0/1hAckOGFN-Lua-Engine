...
void UStoreMain_OfferDetails_C::BacchusInit(UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, class UFortMcpContext* CallFunc_GetContext_ReturnValue, bool CallFunc_IsBROnly_ReturnValue, bool CallFunc_IsRealMoneyPurchasePending_ReturnValue, class UFortMcpContext* CallFunc_GetContext_ReturnValue1, bool CallFunc_BooleanAND_ReturnValue)
{
	static auto Func = Class->GetFunction("StoreMain_OfferDetails_C", "BacchusInit");

	Params::UStoreMain_OfferDetails_C_BacchusInit_Params Parms;
...
// enum class EFortMtxStoreOfferType  Temp_byte_Variable1234                                           (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// enum class EFortMtxStoreOfferType  CallFunc_GetStoreOfferType_ReturnValue12                         (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// enum class EFortMtxStoreOfferType  CallFunc_GetStoreOfferType_ReturnValue123                        (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
