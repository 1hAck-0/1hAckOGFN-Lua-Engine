...
public:
	...
	struct FDedicatedServerUrlContext            Context;                                           // 0x10(0x70)(Parm, OutParm, RepSkip, NativeAccessSpecifierPublic)
};
...
{
public:
	struct FBaseUrlContext                       Context;                                           // 0x0(0x70)(Parm, OutParm, RepSkip, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_F14[0xC];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	struct FDedicatedServerUrlContext            Context;                                           // 0x20(0x70)(Parm, OutParm, RepSkip, NativeAccessSpecifierPublic)
};
...
{
public:
	struct FClientUrlContext                     Context;                                           // 0x0(0x70)(Parm, OutParm, RepSkip, NativeAccessSpecifierPublic)
};
