...
public:
	...
	class AActor*                                CallFunc_GetOwningActorFromActorInfo_ReturnValue12; // 0xF8(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class ABuildingTrap*                         K2Node_DynamicCast_AsBuilding_Trap12;              // 0x100(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_DynamicCast_bSuccess12;                     // 0x108(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	class AActor*                                CallFunc_GetOwningActorFromActorInfo_ReturnValue123; // 0x120(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class ABuildingTrap*                         K2Node_DynamicCast_AsBuilding_Trap123;             // 0x128(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_DynamicCast_bSuccess123;                    // 0x130(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
