...
{
public:
	uint8                                        Pad_4BF8[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FPointerToUberGraphFrame              UberGraphFrame;                                    // 0x380(0x8)(Transient, DuplicateTransient)
	struct FAnimNode_SubInput                    AnimGraphNode_SubInput_E9C497CE4272446DE820C7AC4F9475C9; // 0x388(0x68)()
	struct FAnimNode_Root                        AnimGraphNode_Root_A8263707428C6C1716519682DC411824; // 0x3F0(0x48)()
