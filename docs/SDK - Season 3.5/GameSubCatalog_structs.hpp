...
public:
	...
	uint8                                        Pad_290F[0x70];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	TArray<class FString>                        DenyItemTemplateIds;                               // 0x200(0x10)(ZeroConstructor, Deprecated, NativeAccessSpecifierPrivate)
};
