...
public:
	...
	enum class ESlateVisibility                  Temp_byte_Variable12;                              // 0x3B(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	enum class EFortAnnouncementDisplayPreference Temp_byte_Variable123;                             // 0x3C(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
