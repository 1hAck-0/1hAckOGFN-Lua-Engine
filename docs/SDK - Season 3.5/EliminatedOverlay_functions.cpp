...
// bool                               CallFunc_IsUsingStreamerMode_ReturnValue                         (ZeroConstructor, IsPlainOldData, NoDestructor)
...
void UEliminatedOverlay_C::ProcessDeathReport(struct FFortPlayerDeathReport& FortPlayerDeathReport, class AFortPawn** KillerPawn, bool* DidPlayerKillThemselves, class FText* KillerName, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue, class AFortPlayerControllerAthena* K2Node_DynamicCast_AsFort_Player_Controller_Athena, bool K2Node_DynamicCast_bSuccess, bool CallFunc_IsValid_ReturnValue, bool CallFunc_IsUsingStreamerMode_ReturnValue, bool CallFunc_EqualEqual_ObjectObject_ReturnValue, const class FString& CallFunc_BuildString_Int_ReturnValue, const class FString& CallFunc_GetPlayerName_ReturnValue, class FText CallFunc_Conv_StringToText_ReturnValue, class FText CallFunc_Conv_StringToText_ReturnValue1, const class FString& CallFunc_GetPlayerName_ReturnValue1, class FText CallFunc_Conv_StringToText_ReturnValue12)
{
	...
	Parms.CallFunc_IsUsingStreamerMode_ReturnValue = CallFunc_IsUsingStreamerMode_ReturnValue;
	...
	Parms.CallFunc_GetPlayerName_ReturnValue1 = CallFunc_GetPlayerName_ReturnValue1;
