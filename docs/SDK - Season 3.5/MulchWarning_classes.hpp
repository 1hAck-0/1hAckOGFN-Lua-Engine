...
public:
	...
	class UCommonTextBlock*                      WarningCount;                                      // 0x220(0x8)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UCommonTextBlock*                      WarningText;                                       // 0x228(0x8)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class FText                                  Count;                                             // 0x230(0x18)(Edit, BlueprintVisible, ExposeOnSpawn)
	class FText                                  Warning;                                           // 0x248(0x18)(Edit, BlueprintVisible, ExposeOnSpawn)
