...
{
public:
	uint8                                        Pad_23B8[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_23BA[0x180];                                   // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_23BB[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
