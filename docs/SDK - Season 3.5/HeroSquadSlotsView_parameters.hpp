...
public:
	...
	uint8                                        Pad_491B[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	class FText                                  CallFunc_MakeLiteralText_ReturnValue123;           // 0x1E0(0x18)()
	...
	class FText                                  Temp_text_Variable12;                              // 0x2D0(0x18)()
	class FText                                  Temp_text_Variable123;                             // 0x2E8(0x18)()
	...
	TArray<class UWidget*>                       K2Node_MakeArray_Array12;                          // 0x318(0x10)(ZeroConstructor, ReferenceParm)
	struct FSlateBrush                           K2Node_Select1_Default;                            // 0x328(0x88)()
	bool                                         Temp_bool_Variable12;                              // 0x3B0(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_491E[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class APlayerController*                     CallFunc_GetOwningPlayer_ReturnValue12;            // 0x3B8(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class FText                                  K2Node_Select12_Default;                           // 0x3C0(0x18)()
	class USimpleSquadSlotButton_C*              CallFunc_Create_ReturnValue12;                     // 0x3D8(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FFormatArgumentData                   K2Node_MakeStruct_FormatArgumentData1;             // 0x3E0(0x40)(HasGetValueTypeHash)
	TArray<struct FFormatArgumentData>           K2Node_MakeArray_Array123;                         // 0x420(0x10)(ZeroConstructor, ReferenceParm)
	TArray<class UWidget*>                       K2Node_MakeArray_Array1234;                        // 0x430(0x10)(ZeroConstructor, ReferenceParm)
