...
class UItemCardWidget_C* UItemReceived_Base_C::AddItemCard(const struct FFortReceivedItemLootInfo& NewParam, class UItemCardWidget_C* CallFunc_Create_ReturnValue, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, const struct FMargin& K2Node_MakeStruct_Margin, class UPanelSlot* CallFunc_AddChild_ReturnValue, class UScrollBoxSlot* K2Node_DynamicCast_AsScroll_Box_Slot, bool K2Node_DynamicCast_bSuccess)
{
...
{
	static auto Func = Class->GetFunction("ItemReceived_Base_C", "FinalOnGiftingComplete__DelegateSignature");

	Params::UItemReceived_Base_C_FinalOnGiftingComplete__DelegateSignature_Params Parms;
