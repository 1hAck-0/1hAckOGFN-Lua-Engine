...
void UAthenaReplayBrowserTab_C::CloseRenameDialog(class UCommonUIContext* CallFunc_GetContext_ReturnValue, class UCommonInputManager* CallFunc_GetInputManager_ReturnValue)
{
...
void UAthenaReplayBrowserTab_C::OnConfirmRename(class UAthenaReplayBrowserRowProxyInstance* RowProxy, class FText NewName, const class FString& CallFunc_Conv_TextToString_ReturnValue)
{
...
void UAthenaReplayBrowserTab_C::ExecuteUbergraph_AthenaReplayBrowserTab(int32 EntryPoint, enum class EFortDialogResult K2Node_CustomEvent_Result12345, class FName K2Node_CustomEvent_ResultName12345, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, class FName Temp_name_Variable, enum class EFortDialogResult Temp_byte_Variable, bool CallFunc_EqualEqual_ByteByte_ReturnValue, class UFortFrontEndContext* CallFunc_GetContext_ReturnValue, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate1, enum class EFortDialogResult K2Node_CustomEvent_Result1234, class FName K2Node_CustomEvent_ResultName1234, class FName Temp_name_Variable1, enum class EFortDialogResult Temp_byte_Variable1, enum class EFortDialogResult K2Node_CustomEvent_Result123, class FName K2Node_CustomEvent_ResultName123, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate12, class FName Temp_name_Variable12, enum class EFortDialogResult Temp_byte_Variable12, enum class EFortDialogResult K2Node_CustomEvent_Result12, class FName K2Node_CustomEvent_ResultName12, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate123, class FName Temp_name_Variable123, enum class EFortDialogResult Temp_byte_Variable123, enum class EFortDialogResult K2Node_CustomEvent_Result1, class FName K2Node_CustomEvent_ResultName1, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate1234, class FName Temp_name_Variable1234, enum class EFortDialogResult Temp_byte_Variable1234, enum class EFortDialogResult K2Node_CustomEvent_Result, class FName K2Node_CustomEvent_ResultName, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate12345, class FName Temp_name_Variable12345, enum class EFortDialogResult Temp_byte_Variable12345, class UCommonInputContext* CallFunc_GetContext_ReturnValue1, class UObject* K2Node_ComponentBoundEvent_Item12, enum class ECommonInputType CallFunc_GetCurrentInputType_ReturnValue, bool CallFunc_EqualEqual_ByteByte_ReturnValue1, class UAthenaReplayBrowserRowProxyInstance* K2Node_Event_RowProxy1, bool CallFunc_IsValid_ReturnValue, bool CallFunc_IsValid_ReturnValue1, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue, bool CallFunc_BooleanNOR_ReturnValue, class UAthenaReplayBrowserOldReplayDisclaimer_C* CallFunc_Create_ReturnValue, class FText CallFunc_Conv_StringToText_ReturnValue, bool K2Node_Event_bUsingGamepad, class UObject* K2Node_ComponentBoundEvent_Item1, enum class EFortDialogResult Temp_byte_Variable123456, bool CallFunc_EqualEqual_ByteByte_ReturnValue12, class FName Temp_name_Variable123456, class UWidget* Temp_object_Variable, class UAthenaReplayBrowserRowProxyInstance* K2Node_Event_RowProxy, bool CallFunc_IsValid_ReturnValue12, bool Temp_bool_Variable, class FText CallFunc_Conv_StringToText_ReturnValue1, class UFortAsyncAction_ShowConfirmation_NUI* CallFunc_ShowSimpleConfirmationDialog_NUI_ReturnValue, class UWidget* K2Node_Select_Default, class UFortAsyncAction_ShowConfirmation_NUI* CallFunc_ShowSimpleConfirmationDialog_NUI_ReturnValue1, bool CallFunc_IsValid_ReturnValue123, bool CallFunc_IsValid_ReturnValue1234, enum class EFortDialogResult K2Node_CustomEvent_Result123456, class FName K2Node_CustomEvent_ResultName123456, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate123456, class FText K2Node_Event_Reason123, class UFortAsyncAction_ShowConfirmation_NUI* CallFunc_ShowSimpleConfirmationDialog_NUI_ReturnValue12, class FText K2Node_Event_Reason12, class UFortAsyncAction_ShowConfirmation_NUI* CallFunc_ShowSimpleConfirmationDialog_NUI_ReturnValue123, bool CallFunc_IsValid_ReturnValue12345, bool CallFunc_IsValid_ReturnValue123456, class FText K2Node_Event_Reason1, bool CallFunc_IsValid_ReturnValue1234567, class UFortAsyncAction_ShowConfirmation_NUI* CallFunc_ShowSimpleConfirmationDialog_NUI_ReturnValue1234, bool CallFunc_IsValid_ReturnValue12345678, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate1234567, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate12345678, class FText K2Node_Event_Info, class UFortAsyncAction_ShowConfirmation_NUI* CallFunc_ShowSimpleConfirmationDialog_NUI_ReturnValue12345, class UObject* K2Node_ComponentBoundEvent_Item, bool K2Node_ComponentBoundEvent_bIsSelected, bool CallFunc_IsValid_ReturnValue123456789, class FText K2Node_Event_Reason, class UFortAsyncAction_ShowConfirmation_NUI* CallFunc_ShowSimpleConfirmationDialog_NUI_ReturnValue123456, bool CallFunc_IsValid_ReturnValue12345678910, class UCommonButton* K2Node_ComponentBoundEvent_Button)
{
