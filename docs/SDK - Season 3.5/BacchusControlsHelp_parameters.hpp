...
public:
	...
	class FText                                  CallFunc_MakeLiteralText_ReturnValue1;             // 0x30(0x18)()
	class FText                                  K2Node_Select_Default;                             // 0x48(0x18)(ConstParm)
	...
	enum class ESlateVisibility                  K2Node_Select1_Default;                            // 0x69(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
