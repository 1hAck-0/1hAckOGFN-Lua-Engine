...
public:
	...
	uint8                                        Pad_3CBC[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FActiveGameplayEffectHandle           CallFunc_BP_ApplyGameplayEffectToOwner_ReturnValue12; // 0x114(0x8)(NoDestructor, HasGetValueTypeHash)
	...
	struct FActiveGameplayEffectHandle           CallFunc_BP_ApplyGameplayEffectToOwner_ReturnValue123; // 0x14C(0x8)(NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_3CBE[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class AFortPawn*                             CallFunc_GetActivatingPawn_ReturnValue123;         // 0x158(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
