...
public:
	...
	class UVerticalBox*                          _Vertical_Box__Stats;                              // 0x220(0x8)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	TArray<class FText>                          BodyText;                                          // 0x258(0x10)(Edit, BlueprintVisible, ZeroConstructor, ExposeOnSpawn)
