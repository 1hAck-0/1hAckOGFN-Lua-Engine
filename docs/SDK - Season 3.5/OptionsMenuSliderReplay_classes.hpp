...
public:
	...
	bool                                         ShowLightMaterial;                                 // 0x291(0x1)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_4673[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FVector2D                             MinMaxValue;                                       // 0x294(0x8)(Edit, BlueprintVisible, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_4674[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class FText                                  ValuePrefixText;                                   // 0x2A0(0x18)(Edit, BlueprintVisible)
	class FText                                  ValueSuffixText;                                   // 0x2B8(0x18)(Edit, BlueprintVisible)
	bool                                         MouseDragUpdates;                                  // 0x2D0(0x1)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_4675[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class USoundBase*                            SliderSound;                                       // 0x2D8(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
