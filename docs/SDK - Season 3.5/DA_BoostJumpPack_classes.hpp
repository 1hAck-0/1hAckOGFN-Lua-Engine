...
public:
	...
	struct FGameplayTagContainer                 ErrorReason;                                       // 0xB18(0x20)(Edit, BlueprintVisible, DisableEditOnInstance)
	struct FGameplayTagContainer                 ErrorReasonGamepad;                                // 0xB38(0x20)(Edit, BlueprintVisible, DisableEditOnInstance)
	struct FGameplayTagContainer                 ErrorCannotUse;                                    // 0xB58(0x20)(Edit, BlueprintVisible, DisableEditOnInstance)
