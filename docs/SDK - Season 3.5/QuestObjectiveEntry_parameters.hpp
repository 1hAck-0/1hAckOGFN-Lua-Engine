...
public:
	...
	enum class ESlateVisibility                  Temp_byte_Variable123;                             // 0x5A(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         Temp_bool_Variable1;                               // 0x5B(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	uint8                                        Pad_1230[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class UFortTooltipUIContext*                 CallFunc_GetContext_ReturnValue1;                  // 0x90(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class FText                                  CallFunc_GetCombinedDescription_OutDescription1;   // 0x98(0x18)()
	bool                                         CallFunc_GetCombinedDescription_ReturnValue1;      // 0xB0(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
