...
public:
	...
	class FText                                  CallFunc_Conv_IntToText_ReturnValue12;             // 0xE8(0x18)()
	TArray<struct FFormatArgumentData>           K2Node_MakeArray_Array1;                           // 0x100(0x10)(ZeroConstructor, ReferenceParm)
	struct FFormatArgumentData                   K2Node_MakeStruct_FormatArgumentData12;            // 0x110(0x40)(HasGetValueTypeHash)
	class FText                                  CallFunc_Format_ReturnValue1;                      // 0x150(0x18)()
	TArray<struct FFormatArgumentData>           K2Node_MakeArray_Array12;                          // 0x168(0x10)(ZeroConstructor, ReferenceParm)
	class FText                                  CallFunc_Format_ReturnValue12;                     // 0x178(0x18)()
};
...
public:
	...
	class FString                                Temp_string_Variable12;                            // 0x30(0x10)(ZeroConstructor, HasGetValueTypeHash)
	class FString                                Temp_string_Variable123;                           // 0x40(0x10)(ZeroConstructor, HasGetValueTypeHash)
	...
	class FString                                Temp_string_Variable1234;                          // 0x60(0x10)(ZeroConstructor, HasGetValueTypeHash)
	class FString                                Temp_string_Variable12345;                         // 0x70(0x10)(ZeroConstructor, HasGetValueTypeHash)
	class FString                                Temp_string_Variable123456;                        // 0x80(0x10)(ZeroConstructor, HasGetValueTypeHash)
	class FString                                Temp_string_Variable1234567;                       // 0x90(0x10)(ZeroConstructor, HasGetValueTypeHash)
